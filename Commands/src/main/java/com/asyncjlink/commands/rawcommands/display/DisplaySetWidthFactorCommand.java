...
/**
 * Display.SetWidthFactor &mdash; pfcDisplay.
 *
 * <pre>
 * void SetWidthFactor(double) throws jxthrowable
 * </pre>
 */
public final class DisplaySetWidthFactorCommand implements Command {

    @Override public String name() { return "Display.SetWidthFactor"; }
    @Override public String jlinkPackage() { return "pfcDisplay"; }
    @Override public String receiverType() { return "Display"; }
    @Override public String signature() { return "void SetWidthFactor(double) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Display.SetWidthFactor \u2014 pfcDisplay")
