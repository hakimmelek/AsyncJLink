...
/**
 * Surface.GetIsVisible &mdash; pfcGeometry.
 *
 * <pre>
 * boolean GetIsVisible() throws jxthrowable
 * </pre>
 */
public final class SurfaceGetIsVisibleCommand implements Command {

    @Override public String name() { return "Surface.GetIsVisible"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Surface.GetIsVisible \u2014 pfcGeometry")
