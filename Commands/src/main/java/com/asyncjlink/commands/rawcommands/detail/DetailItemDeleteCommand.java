...
/**
 * DetailItem.Delete &mdash; pfcDetail.
 *
 * <pre>
 * void Delete() throws jxthrowable
 * </pre>
 */
public final class DetailItemDeleteCommand implements Command {

    @Override public String name() { return "DetailItem.Delete"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("DetailItem.Delete \u2014 pfcDetail")
