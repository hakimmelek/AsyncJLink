...
/**
 * ExternalDataSlot.Delete &mdash; pfcExternal.
 *
 * <pre>
 * void Delete() throws jxthrowable
 * </pre>
 */
public final class ExternalDataSlotDeleteCommand implements Command {

    @Override public String name() { return "ExternalDataSlot.Delete"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("ExternalDataSlot.Delete \u2014 pfcExternal")
