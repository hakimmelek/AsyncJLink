...
/**
 * ModelItemOwner.GetItemByName &mdash; pfcModelItem.
 *
 * <pre>
 * ModelItem GetItemByName(ModelItemType, String) throws jxthrowable
 * </pre>
 */
public final class ModelItemOwnerGetItemByNameCommand implements Command {

    @Override public String name() { return "ModelItemOwner.GetItemByName"; }
    @Override public String jlinkPackage() { return "pfcModelItem"; }
    @Override public String receiverType() { return "ModelItemOwner"; }
    @Override public String signature() { return "ModelItem GetItemByName(ModelItemType, String) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("ModelItemOwner.GetItemByName \u2014 pfcModelItem")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.GetItemByName(modelItemType, value), "ModelItem");
    }
}
