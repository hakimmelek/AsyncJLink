...
/**
 * Parameter.Delete &mdash; pfcModelItem.
 *
 * <pre>
 * void Delete() throws jxthrowable
 * </pre>
 */
public final class ParameterDeleteCommand implements Command {

    @Override public String name() { return "Parameter.Delete"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Parameter.Delete \u2014 pfcModelItem")
