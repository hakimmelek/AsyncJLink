...
/**
 * Material.SetYoungModulus &mdash; pfcPart.
 *
 * <pre>
 * void SetYoungModulus(double) throws jxthrowable
 * </pre>
 */
public final class MaterialSetYoungModulusCommand implements Command {

    @Override public String name() { return "Material.SetYoungModulus"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void SetYoungModulus(double) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetYoungModulus \u2014 pfcPart")
