...
/**
 * Material.SetMassDensity &mdash; pfcPart.
 *
 * <pre>
 * void SetMassDensity(double) throws jxthrowable
 * </pre>
 */
public final class MaterialSetMassDensityCommand implements Command {

    @Override public String name() { return "Material.SetMassDensity"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void SetMassDensity(double) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetMassDensity \u2014 pfcPart")
