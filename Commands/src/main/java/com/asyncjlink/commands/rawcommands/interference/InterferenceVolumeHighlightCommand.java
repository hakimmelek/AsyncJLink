...
/**
 * InterferenceVolume.Highlight &mdash; pfcInterference.
 *
 * <pre>
 * void Highlight(StdColor) throws jxthrowable
 * </pre>
 */
public final class InterferenceVolumeHighlightCommand implements Command {

    @Override public String name() { return "InterferenceVolume.Highlight"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("InterferenceVolume.Highlight \u2014 pfcInterference")
