...
/**
 * DetailSymbolDefItem.SetSubgroupLevelExclusive &mdash; pfcDetail.
 *
 * <pre>
 * void SetSubgroupLevelExclusive(DetailSymbolGroup) throws jxthrowable
 * </pre>
 */
public final class DetailSymbolDefItemSetSubgroupLevelExclusiveCommand implements Command {

    @Override public String name() { return "DetailSymbolDefItem.SetSubgroupLevelExclusive"; }
    @Override public String jlinkPackage() { return "pfcDetail"; }
    @Override public String receiverType() { return "DetailSymbolDefItem"; }
    @Override public String signature() { return "void SetSubgroupLevelExclusive(DetailSymbolGroup) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("DetailSymbolDefItem.SetSubgroupLevelExclusive \u2014 pfcDetail")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        target.SetSubgroupLevelExclusive(detailSymbolGroup);
        return Marshal.ok();
    }
}
