...
/**
 * Table.IsCommentCell &mdash; pfcTable.
 *
 * <pre>
 * boolean IsCommentCell(TableCell) throws jxthrowable
 * </pre>
 */
public final class TableIsCommentCellCommand implements Command {

    @Override public String name() { return "Table.IsCommentCell"; }
    @Override public String jlinkPackage() { return "pfcTable"; }
    @Override public String receiverType() { return "Table"; }
    @Override public String signature() { return "boolean IsCommentCell(TableCell) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Table.IsCommentCell \u2014 pfcTable")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.IsCommentCell(tableCell), "boolean");
    }
}
