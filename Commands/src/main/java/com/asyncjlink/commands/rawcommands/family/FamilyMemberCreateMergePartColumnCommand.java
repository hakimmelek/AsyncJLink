...
/**
 * FamilyMember.CreateMergePartColumn &mdash; pfcFamily.
 *
 * <pre>
 * FamColMergePart CreateMergePartColumn(Feature) throws jxthrowable
 * </pre>
 */
public final class FamilyMemberCreateMergePartColumnCommand implements Command {

    @Override public String name() { return "FamilyMember.CreateMergePartColumn"; }
    @Override public String jlinkPackage() { return "pfcFamily"; }
    @Override public String receiverType() { return "FamilyMember"; }
    @Override public String signature() { return "FamColMergePart CreateMergePartColumn(Feature) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("FamilyMember.CreateMergePartColumn \u2014 pfcFamily")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.CreateMergePartColumn(feature), "FamColMergePart");
    }
}
