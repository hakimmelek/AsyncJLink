...
/**
 * Display.GetFontByName &mdash; pfcDisplay.
 *
 * <pre>
 * Font GetFontByName(String) throws jxthrowable
 * </pre>
 */
public final class DisplayGetFontByNameCommand implements Command {

    @Override public String name() { return "Display.GetFontByName"; }
    @Override public String jlinkPackage() { return "pfcDisplay"; }
    @Override public String receiverType() { return "Display"; }
    @Override public String signature() { return "Font GetFontByName(String) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Display.GetFontByName \u2014 pfcDisplay")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.GetFontByName(value), "Font");
    }
}
