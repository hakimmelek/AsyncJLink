...
/**
 * JLinkApplication.ExecuteTask &mdash; pfcJLink.
 *
 * <pre>
 * Arguments ExecuteTask(String, Arguments) throws jxthrowable
 * </pre>
 */
public final class JLinkApplicationExecuteTaskCommand implements Command {

    @Override public String name() { return "JLinkApplication.ExecuteTask"; }
    @Override public String jlinkPackage() { return "pfcJLink"; }
    @Override public String receiverType() { return "JLinkApplication"; }
    @Override public String signature() { return "Arguments ExecuteTask(String, Arguments) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("JLinkApplication.ExecuteTask \u2014 pfcJLink")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.ExecuteTask(value, arguments), "Arguments");
    }
}
