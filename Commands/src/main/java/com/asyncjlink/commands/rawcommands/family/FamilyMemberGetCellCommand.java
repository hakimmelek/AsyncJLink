...
/**
 * FamilyMember.GetCell &mdash; pfcFamily.
 *
 * <pre>
 * ParamValue GetCell(FamilyTableColumn, FamilyTableRow) throws jxthrowable
 * </pre>
 */
public final class FamilyMemberGetCellCommand implements Command {

    @Override public String name() { return "FamilyMember.GetCell"; }
    @Override public String jlinkPackage() { return "pfcFamily"; }
    @Override public String receiverType() { return "FamilyMember"; }
    @Override public String signature() { return "ParamValue GetCell(FamilyTableColumn, FamilyTableRow) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("FamilyMember.GetCell \u2014 pfcFamily")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.GetCell(familyTableColumn, familyTableRow), "ParamValue");
    }
}
