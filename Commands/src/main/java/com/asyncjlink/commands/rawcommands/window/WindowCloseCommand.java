...
/**
 * Window.Close &mdash; pfcWindow.
 *
 * <pre>
 * void Close() throws jxthrowable
 * </pre>
 */
public final class WindowCloseCommand implements Command {

    @Override public String name() { return "Window.Close"; }
    @Override public String jlinkPackage() { return "pfcWindow"; }
    @Override public String receiverType() { return "Window"; }
    @Override public String signature() { return "void Close() throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Window.Close \u2014 pfcWindow")
