...
/**
 * Unit.Delete &mdash; pfcUnits.
 *
 * <pre>
 * void Delete() throws jxthrowable
 * </pre>
 */
public final class UnitDeleteCommand implements Command {

    @Override public String name() { return "Unit.Delete"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Unit.Delete \u2014 pfcUnits")
