...
/**
 * Table.Display &mdash; pfcTable.
 *
 * <pre>
 * void Display() throws jxthrowable
 * </pre>
 */
public final class TableDisplayCommand implements Command {

    @Override public String name() { return "Table.Display"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Table.Display \u2014 pfcTable")
