...
/**
 * DetailNoteItem.Show &mdash; pfcDetail.
 *
 * <pre>
 * void Show() throws jxthrowable
 * </pre>
 */
public final class DetailNoteItemShowCommand implements Command {

    @Override public String name() { return "DetailNoteItem.Show"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("DetailNoteItem.Show \u2014 pfcDetail")
