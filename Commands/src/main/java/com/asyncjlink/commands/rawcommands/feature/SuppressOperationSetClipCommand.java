...
/**
 * SuppressOperation.SetClip &mdash; pfcFeature.
 *
 * <pre>
 * void SetClip(boolean) throws jxthrowable
 * </pre>
 */
public final class SuppressOperationSetClipCommand implements Command {

    @Override public String name() { return "SuppressOperation.SetClip"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("SuppressOperation.SetClip \u2014 pfcFeature")
