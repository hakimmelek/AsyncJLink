...
/**
 * Material.SetThermExpCoef &mdash; pfcPart.
 *
 * <pre>
 * void SetThermExpCoef(double) throws jxthrowable
 * </pre>
 */
public final class MaterialSetThermExpCoefCommand implements Command {

    @Override public String name() { return "Material.SetThermExpCoef"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void SetThermExpCoef(double) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetThermExpCoef \u2014 pfcPart")
