...
/**
 * View.Reset &mdash; pfcView.
 *
 * <pre>
 * void Reset() throws jxthrowable
 * </pre>
 */
public final class ViewResetCommand implements Command {

    @Override public String name() { return "View.Reset"; }
    @Override public String jlinkPackage() { return "pfcView"; }
    @Override public String receiverType() { return "View"; }
    @Override public String signature() { return "void Reset() throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("View.Reset \u2014 pfcView")
