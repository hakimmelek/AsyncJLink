...
/**
 * Display.SetSlantAngle &mdash; pfcDisplay.
 *
 * <pre>
 * void SetSlantAngle(double) throws jxthrowable
 * </pre>
 */
public final class DisplaySetSlantAngleCommand implements Command {

    @Override public String name() { return "Display.SetSlantAngle"; }
    @Override public String jlinkPackage() { return "pfcDisplay"; }
    @Override public String receiverType() { return "Display"; }
    @Override public String signature() { return "void SetSlantAngle(double) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Display.SetSlantAngle \u2014 pfcDisplay")
