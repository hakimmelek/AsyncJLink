...
/**
 * Note.Delete &mdash; pfcNote.
 *
 * <pre>
 * void Delete() throws jxthrowable
 * </pre>
 */
public final class NoteDeleteCommand implements Command {

    @Override public String name() { return "Note.Delete"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Note.Delete \u2014 pfcNote")
