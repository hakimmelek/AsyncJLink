...
/**
 * Material.SetEmissivity &mdash; pfcPart.
 *
 * <pre>
 * void SetEmissivity(double) throws jxthrowable
 * </pre>
 */
public final class MaterialSetEmissivityCommand implements Command {

    @Override public String name() { return "Material.SetEmissivity"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void SetEmissivity(double) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetEmissivity \u2014 pfcPart")
