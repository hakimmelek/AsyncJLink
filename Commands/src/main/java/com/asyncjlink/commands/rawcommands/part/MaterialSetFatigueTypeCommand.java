...
/**
 * Material.SetFatigueType &mdash; pfcPart.
 *
 * <pre>
 * void SetFatigueType(String) throws jxthrowable
 * </pre>
 */
public final class MaterialSetFatigueTypeCommand implements Command {

    @Override public String name() { return "Material.SetFatigueType"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void SetFatigueType(String) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetFatigueType \u2014 pfcPart")
