...
/**
 * Selection.Display &mdash; pfcSelect.
 *
 * <pre>
 * void Display() throws jxthrowable
 * </pre>
 */
public final class SelectionDisplayCommand implements Command {

    @Override public String name() { return "Selection.Display"; }
    @Override public String jlinkPackage() { return "pfcSelect"; }
    @Override public String receiverType() { return "Selection"; }
    @Override public String signature() { return "void Display() throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Selection.Display \u2014 pfcSelect")
