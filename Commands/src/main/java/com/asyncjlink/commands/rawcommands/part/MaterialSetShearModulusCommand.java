...
/**
 * Material.SetShearModulus &mdash; pfcPart.
 *
 * <pre>
 * void SetShearModulus(double) throws jxthrowable
 * </pre>
 */
public final class MaterialSetShearModulusCommand implements Command {

    @Override public String name() { return "Material.SetShearModulus"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void SetShearModulus(double) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetShearModulus \u2014 pfcPart")
