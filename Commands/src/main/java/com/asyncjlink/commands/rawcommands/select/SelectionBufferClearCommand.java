...
/**
 * SelectionBuffer.Clear &mdash; pfcSelect.
 *
 * <pre>
 * void Clear() throws jxthrowable
 * </pre>
 */
public final class SelectionBufferClearCommand implements Command {

    @Override public String name() { return "SelectionBuffer.Clear"; }
    @Override public String jlinkPackage() { return "pfcSelect"; }
    @Override public String receiverType() { return "SelectionBuffer"; }
    @Override public String signature() { return "void Clear() throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("SelectionBuffer.Clear \u2014 pfcSelect")
