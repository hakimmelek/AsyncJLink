...
/**
 * NURBSSurface.GetUDegree &mdash; pfcGeometry.
 *
 * <pre>
 * int GetUDegree() throws jxthrowable
 * </pre>
 */
public final class NURBSSurfaceGetUDegreeCommand implements Command {

    @Override public String name() { return "NURBSSurface.GetUDegree"; }
    @Override public String jlinkPackage() { return "pfcGeometry"; }
    @Override public String receiverType() { return "NURBSSurface"; }
    @Override public String signature() { return "int GetUDegree() throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("NURBSSurface.GetUDegree \u2014 pfcGeometry")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.GetUDegree(), "int");
    }
}
