...
/**
 * View.GetName &mdash; pfcView.
 *
 * <pre>
 * String GetName() throws jxthrowable
 * </pre>
 */
public final class ViewGetNameCommand implements Command {

    @Override public String name() { return "View.GetName"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("View.GetName \u2014 pfcView")
