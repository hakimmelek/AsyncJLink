...
/**
 * FamilyTableRow.Erase &mdash; pfcFamily.
 *
 * <pre>
 * void Erase() throws jxthrowable
 * </pre>
 */
public final class FamilyTableRowEraseCommand implements Command {

    @Override public String name() { return "FamilyTableRow.Erase"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("FamilyTableRow.Erase \u2014 pfcFamily")
