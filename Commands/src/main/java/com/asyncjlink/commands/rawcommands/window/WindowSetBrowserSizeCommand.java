...
/**
 * Window.SetBrowserSize &mdash; pfcWindow.
 *
 * <pre>
 * void SetBrowserSize(double) throws jxthrowable
 * </pre>
 */
public final class WindowSetBrowserSizeCommand implements Command {

    @Override public String name() { return "Window.SetBrowserSize"; }
    @Override public String jlinkPackage() { return "pfcWindow"; }
    @Override public String receiverType() { return "Window"; }
    @Override public String signature() { return "void SetBrowserSize(double) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Window.SetBrowserSize \u2014 pfcWindow")
