...
/**
 * Table.GetColumnSize &mdash; pfcTable.
 *
 * <pre>
 * double GetColumnSize(int, int) throws jxthrowable
 * </pre>
 */
public final class TableGetColumnSizeCommand implements Command {

    @Override public String name() { return "Table.GetColumnSize"; }
    @Override public String jlinkPackage() { return "pfcTable"; }
    @Override public String receiverType() { return "Table"; }
    @Override public String signature() { return "double GetColumnSize(int, int) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Table.GetColumnSize \u2014 pfcTable")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.GetColumnSize(value1, value2), "double");
    }
}
