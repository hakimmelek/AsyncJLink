...
/**
 * Window.Clear &mdash; pfcWindow.
 *
 * <pre>
 * void Clear() throws jxthrowable
 * </pre>
 */
public final class WindowClearCommand implements Command {

    @Override public String name() { return "Window.Clear"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Window.Clear \u2014 pfcWindow")
