...
/**
 * Display.CreateDisplayList3D &mdash; pfcDisplay.
 *
 * <pre>
 * DisplayList3D CreateDisplayList3D(int, DisplayListener) throws jxthrowable
 * </pre>
 *
 * <p>Catalogued but not invocable: it requires a live DisplayListener callback.
 */
public final class DisplayCreateDisplayList3DCommand implements Command {

    @Override public String name() { return "Display.CreateDisplayList3D"; }
    @Override public String jlinkPackage() { return "pfcDisplay"; }
    @Override public String receiverType() { return "Display"; }
    @Override public String signature() { return "DisplayList3D CreateDisplayList3D(int, DisplayListener) throws jxthrowable"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Display.CreateDisplayList3D \u2014 pfcDisplay")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        throw CommandException.unsupported(
                "Display.CreateDisplayList3D", unsupportedReason());
    }
}
