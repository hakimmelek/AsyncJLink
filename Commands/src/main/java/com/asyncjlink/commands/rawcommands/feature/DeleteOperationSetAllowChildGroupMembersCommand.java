...
/**
 * DeleteOperation.SetAllowChildGroupMembers &mdash; pfcFeature.
 *
 * <pre>
 * void SetAllowChildGroupMembers(boolean) throws jxthrowable
 * </pre>
 */
public final class DeleteOperationSetAllowChildGroupMembersCommand implements Command {

    @Override public String name() { return "DeleteOperation.SetAllowChildGroupMembers"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("DeleteOperation.SetAllowChildGroupMembers \u2014 pfcFeature")
