...
/**
 * Material.SetStressLimCompress &mdash; pfcPart.
 *
 * <pre>
 * void SetStressLimCompress(double) throws jxthrowable
 * </pre>
 */
public final class MaterialSetStressLimCompressCommand implements Command {

    @Override public String name() { return "Material.SetStressLimCompress"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void SetStressLimCompress(double) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetStressLimCompress \u2014 pfcPart")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        target.SetStressLimCompress(value);
        return Marshal.ok();
    }
}
