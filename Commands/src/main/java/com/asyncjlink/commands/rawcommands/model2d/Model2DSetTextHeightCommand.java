...
/**
 * Model2D.SetTextHeight &mdash; pfcModel2D.
 *
 * <pre>
 * void SetTextHeight(double) throws jxthrowable
 * </pre>
 */
public final class Model2DSetTextHeightCommand implements Command {

    @Override public String name() { return "Model2D.SetTextHeight"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Model2D.SetTextHeight \u2014 pfcModel2D")
