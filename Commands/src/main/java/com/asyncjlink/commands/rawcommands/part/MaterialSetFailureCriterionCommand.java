...
/**
 * Material.SetFailureCriterion &mdash; pfcPart.
 *
 * <pre>
 * void SetFailureCriterion(String) throws jxthrowable
 * </pre>
 */
public final class MaterialSetFailureCriterionCommand implements Command {

    @Override public String name() { return "Material.SetFailureCriterion"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void SetFailureCriterion(String) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetFailureCriterion \u2014 pfcPart")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        target.SetFailureCriterion(value);
        return Marshal.ok();
    }
}
