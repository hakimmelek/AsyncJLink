...
/**
 * BaseDimension.GetTexts &mdash; pfcDimension.
 *
 * <pre>
 * stringseq GetTexts() throws jxthrowable
 * </pre>
 */
public final class BaseDimensionGetTextsCommand implements Command {

    @Override public String name() { return "BaseDimension.GetTexts"; }
    @Override public String jlinkPackage() { return "pfcDimension"; }
    @Override public String receiverType() { return "BaseDimension"; }
    @Override public String signature() { return "stringseq GetTexts() throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("BaseDimension.GetTexts \u2014 pfcDimension")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.GetTexts(), "stringseq");
    }
}
