...
/**
 * Window.Repaint &mdash; pfcWindow.
 *
 * <pre>
 * void Repaint() throws jxthrowable
 * </pre>
 */
public final class WindowRepaintCommand implements Command {

    @Override public String name() { return "Window.Repaint"; }
    @Override public String jlinkPackage() { return "pfcWindow"; }
    @Override public String receiverType() { return "Window"; }
    @Override public String signature() { return "void Repaint() throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Window.Repaint \u2014 pfcWindow")
