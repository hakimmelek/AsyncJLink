...
import com.ptc.pfc.pfcPart.MaterialProperty;
import com.ptc.pfc.pfcPart.MaterialPropertyType;

/**
 * Material.SetPropertyValue &mdash; pfcPart.
 *
 * <pre>
 * void SetPropertyValue(MaterialPropertyType, MaterialProperty) throws jxthrowable
 * </pre>
 */
public final class MaterialSetPropertyValueCommand implements Command {

    @Override public String name() { return "Material.SetPropertyValue"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void SetPropertyValue(MaterialPropertyType, MaterialProperty) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetPropertyValue \u2014 pfcPart")
                ...
                .optional("materialProperty", JsonSchema.dataObject("MaterialProperty"),
                        "MaterialProperty options object; its fields are passed to the pfc factory and setters.")
                ;
    }
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        MaterialProperty materialProperty = Marshal.in(ctx, params.get("materialProperty"),
                "MaterialProperty", MaterialProperty.class, "materialProperty");
        target.SetPropertyValue(materialPropertyType, materialProperty);
        return Marshal.ok();
    }
}
