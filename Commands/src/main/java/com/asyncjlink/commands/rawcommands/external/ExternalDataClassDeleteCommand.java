...
/**
 * ExternalDataClass.Delete &mdash; pfcExternal.
 *
 * <pre>
 * void Delete() throws jxthrowable
 * </pre>
 */
public final class ExternalDataClassDeleteCommand implements Command {

    @Override public String name() { return "ExternalDataClass.Delete"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("ExternalDataClass.Delete \u2014 pfcExternal")
