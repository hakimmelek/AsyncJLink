...
/**
 * BaseSession.SetStdColorFromRGB &mdash; pfcSession.
 *
 * <pre>
 * void SetStdColorFromRGB(StdColor, ColorRGB) throws jxthrowable
 * </pre>
 */
public final class BaseSessionSetStdColorFromRGBCommand implements Command {

    @Override public String name() { return "BaseSession.SetStdColorFromRGB"; }
    @Override public String jlinkPackage() { return "pfcSession"; }
    @Override public String receiverType() { return "BaseSession"; }
    @Override public String signature() { return "void SetStdColorFromRGB(StdColor, ColorRGB) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("BaseSession.SetStdColorFromRGB \u2014 pfcSession")
                ...
                .optional("colorRGB", JsonSchema.dataObject("ColorRGB"),
                        "ColorRGB options object; its fields are passed to the pfc factory and setters.")
                ;
    }
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        ColorRGB colorRGB = Marshal.in(ctx, params.get("colorRGB"),
                "ColorRGB", ColorRGB.class, "colorRGB");
        target.SetStdColorFromRGB(stdColor, colorRGB);
        return Marshal.ok();
    }
}
