...
/**
 * Server.UndoCheckout &mdash; pfcServer.
 *
 * <pre>
 * void UndoCheckout(Model) throws jxthrowable
 * </pre>
 */
public final class ServerUndoCheckoutCommand implements Command {

    @Override public String name() { return "Server.UndoCheckout"; }
    @Override public String jlinkPackage() { return "pfcServer"; }
    @Override public String receiverType() { return "Server"; }
    @Override public String signature() { return "void UndoCheckout(Model) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Server.UndoCheckout \u2014 pfcServer")
