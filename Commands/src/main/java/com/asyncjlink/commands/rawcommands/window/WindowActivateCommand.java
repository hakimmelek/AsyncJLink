...
/**
 * Window.Activate &mdash; pfcWindow.
 *
 * <pre>
 * void Activate() throws jxthrowable
 * </pre>
 */
public final class WindowActivateCommand implements Command {

    @Override public String name() { return "Window.Activate"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Window.Activate \u2014 pfcWindow")
