...
/**
 * FamilyMember.AddColumn &mdash; pfcFamily.
 *
 * <pre>
 * FamilyTableColumn AddColumn(FamilyTableColumn, ParamValues) throws jxthrowable
 * </pre>
 */
public final class FamilyMemberAddColumnCommand implements Command {

    @Override public String name() { return "FamilyMember.AddColumn"; }
    @Override public String jlinkPackage() { return "pfcFamily"; }
    @Override public String receiverType() { return "FamilyMember"; }
    @Override public String signature() { return "FamilyTableColumn AddColumn(FamilyTableColumn, ParamValues) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("FamilyMember.AddColumn \u2014 pfcFamily")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.AddColumn(familyTableColumn, paramValues), "FamilyTableColumn");
    }
}
