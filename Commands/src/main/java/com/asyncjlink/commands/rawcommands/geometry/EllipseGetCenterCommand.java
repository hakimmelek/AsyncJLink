...
/**
 * Ellipse.GetCenter &mdash; pfcGeometry.
 *
 * <pre>
 * Point3D GetCenter() throws jxthrowable
 * </pre>
 */
public final class EllipseGetCenterCommand implements Command {

    @Override public String name() { return "Ellipse.GetCenter"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Ellipse.GetCenter \u2014 pfcGeometry")
