...
/**
 * ClearanceData.SetIsInterfering &mdash; pfcInterference.
 *
 * <pre>
 * void SetIsInterfering(boolean) throws jxthrowable
 * </pre>
 */
public final class ClearanceDataSetIsInterferingCommand implements Command {

    @Override public String name() { return "ClearanceData.SetIsInterfering"; }
    @Override public String jlinkPackage() { return "pfcInterference"; }
    @Override public String receiverType() { return "ClearanceData"; }
    @Override public String signature() { return "void SetIsInterfering(boolean) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("ClearanceData.SetIsInterfering \u2014 pfcInterference")
