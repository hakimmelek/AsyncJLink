...
/**
 * Layer.RemoveItem &mdash; pfcLayer.
 *
 * <pre>
 * void RemoveItem(ModelItem) throws jxthrowable
 * </pre>
 */
public final class LayerRemoveItemCommand implements Command {

    @Override public String name() { return "Layer.RemoveItem"; }
    @Override public String jlinkPackage() { return "pfcLayer"; }
    @Override public String receiverType() { return "Layer"; }
    @Override public String signature() { return "void RemoveItem(ModelItem) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Layer.RemoveItem \u2014 pfcLayer")
