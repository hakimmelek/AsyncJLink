...
/**
 * View2D.GetModel &mdash; pfcView2D.
 *
 * <pre>
 * Model GetModel() throws jxthrowable
 * </pre>
 */
public final class View2DGetModelCommand implements Command {

    @Override public String name() { return "View2D.GetModel"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("View2D.GetModel \u2014 pfcView2D")
