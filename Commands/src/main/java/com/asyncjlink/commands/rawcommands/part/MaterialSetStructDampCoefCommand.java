...
/**
 * Material.SetStructDampCoef &mdash; pfcPart.
 *
 * <pre>
 * void SetStructDampCoef(double) throws jxthrowable
 * </pre>
 */
public final class MaterialSetStructDampCoefCommand implements Command {

    @Override public String name() { return "Material.SetStructDampCoef"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void SetStructDampCoef(double) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetStructDampCoef \u2014 pfcPart")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        target.SetStructDampCoef(value);
        return Marshal.ok();
    }
}
