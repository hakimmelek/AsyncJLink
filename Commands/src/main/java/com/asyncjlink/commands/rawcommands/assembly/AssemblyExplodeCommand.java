...
/**
 * Assembly.Explode &mdash; pfcAssembly.
 *
 * <pre>
 * void Explode() throws jxthrowable
 * </pre>
 */
public final class AssemblyExplodeCommand implements Command {

    @Override public String name() { return "Assembly.Explode"; }
    @Override public String jlinkPackage() { return "pfcAssembly"; }
    @Override public String receiverType() { return "Assembly"; }
    @Override public String signature() { return "void Explode() throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Assembly.Explode \u2014 pfcAssembly")
