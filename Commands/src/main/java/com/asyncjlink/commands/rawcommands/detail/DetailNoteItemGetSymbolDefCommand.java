...
/**
 * DetailNoteItem.GetSymbolDef &mdash; pfcDetail.
 *
 * <pre>
 * DetailSymbolDefItem GetSymbolDef() throws jxthrowable
 * </pre>
 */
public final class DetailNoteItemGetSymbolDefCommand implements Command {

    @Override public String name() { return "DetailNoteItem.GetSymbolDef"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("DetailNoteItem.GetSymbolDef \u2014 pfcDetail")
