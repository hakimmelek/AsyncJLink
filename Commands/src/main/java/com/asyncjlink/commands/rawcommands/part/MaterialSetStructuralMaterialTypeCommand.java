...
/**
 * Material.SetStructuralMaterialType &mdash; pfcPart.
 *
 * <pre>
 * void SetStructuralMaterialType(MaterialType) throws jxthrowable
 * </pre>
 */
public final class MaterialSetStructuralMaterialTypeCommand implements Command {

    @Override public String name() { return "Material.SetStructuralMaterialType"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void SetStructuralMaterialType(MaterialType) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetStructuralMaterialType \u2014 pfcPart")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        target.SetStructuralMaterialType(materialType);
        return Marshal.ok();
    }
}
