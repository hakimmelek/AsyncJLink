...
/**
 * Window.Refresh &mdash; pfcWindow.
 *
 * <pre>
 * void Refresh() throws jxthrowable
 * </pre>
 */
public final class WindowRefreshCommand implements Command {

    @Override public String name() { return "Window.Refresh"; }
    @Override public String jlinkPackage() { return "pfcWindow"; }
    @Override public String receiverType() { return "Window"; }
    @Override public String signature() { return "void Refresh() throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Window.Refresh \u2014 pfcWindow")
