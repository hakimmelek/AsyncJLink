...
/**
 * Material.SetBendTable &mdash; pfcPart.
 *
 * <pre>
 * void SetBendTable(String) throws jxthrowable
 * </pre>
 */
public final class MaterialSetBendTableCommand implements Command {

    @Override public String name() { return "Material.SetBendTable"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void SetBendTable(String) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetBendTable \u2014 pfcPart")
