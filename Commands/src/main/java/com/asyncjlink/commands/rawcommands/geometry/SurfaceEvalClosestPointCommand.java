...
/**
 * Surface.EvalClosestPoint &mdash; pfcGeometry.
 *
 * <pre>
 * Point3D EvalClosestPoint(Point3D) throws jxthrowable
 * </pre>
 */
public final class SurfaceEvalClosestPointCommand implements Command {

    @Override public String name() { return "Surface.EvalClosestPoint"; }
    @Override public String jlinkPackage() { return "pfcGeometry"; }
    @Override public String receiverType() { return "Surface"; }
    @Override public String signature() { return "Point3D EvalClosestPoint(Point3D) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Surface.EvalClosestPoint \u2014 pfcGeometry")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.EvalClosestPoint(point3D), "Point3D");
    }
}
