...
/**
 * Display.SetTextHeight &mdash; pfcDisplay.
 *
 * <pre>
 * void SetTextHeight(double) throws jxthrowable
 * </pre>
 */
public final class DisplaySetTextHeightCommand implements Command {

    @Override public String name() { return "Display.SetTextHeight"; }
    @Override public String jlinkPackage() { return "pfcDisplay"; }
    @Override public String receiverType() { return "Display"; }
    @Override public String signature() { return "void SetTextHeight(double) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Display.SetTextHeight \u2014 pfcDisplay")
