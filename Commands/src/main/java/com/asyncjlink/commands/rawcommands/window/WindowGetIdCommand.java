...
/**
 * Window.GetId &mdash; pfcWindow.
 *
 * <pre>
 * int GetId() throws jxthrowable
 * </pre>
 */
public final class WindowGetIdCommand implements Command {

    @Override public String name() { return "Window.GetId"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Window.GetId \u2014 pfcWindow")
