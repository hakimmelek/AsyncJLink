...
/**
 * ComponentFeat.Regenerate &mdash; pfcComponentFeat.
 *
 * <pre>
 * void Regenerate() throws jxthrowable
 * </pre>
 */
public final class ComponentFeatRegenerateCommand implements Command {

    @Override public String name() { return "ComponentFeat.Regenerate"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("ComponentFeat.Regenerate \u2014 pfcComponentFeat")
