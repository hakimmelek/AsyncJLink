...
/**
 * Model2D.AddSimplifiedRep &mdash; pfcModel2D.
 *
 * <pre>
 * void AddSimplifiedRep(SimpRep) throws jxthrowable
 * </pre>
 */
public final class Model2DAddSimplifiedRepCommand implements Command {

    @Override public String name() { return "Model2D.AddSimplifiedRep"; }
    @Override public String jlinkPackage() { return "pfcModel2D"; }
    @Override public String receiverType() { return "Model2D"; }
    @Override public String signature() { return "void AddSimplifiedRep(SimpRep) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Model2D.AddSimplifiedRep \u2014 pfcModel2D")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        target.AddSimplifiedRep(simpRep);
        return Marshal.ok();
    }
}
