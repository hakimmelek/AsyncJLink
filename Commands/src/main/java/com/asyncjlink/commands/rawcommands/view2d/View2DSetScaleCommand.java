...
/**
 * View2D.SetScale &mdash; pfcView2D.
 *
 * <pre>
 * void SetScale(double) throws jxthrowable
 * </pre>
 */
public final class View2DSetScaleCommand implements Command {

    @Override public String name() { return "View2D.SetScale"; }
    @Override public String jlinkPackage() { return "pfcView2D"; }
    @Override public String receiverType() { return "View2D"; }
    @Override public String signature() { return "void SetScale(double) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("View2D.SetScale \u2014 pfcView2D")
