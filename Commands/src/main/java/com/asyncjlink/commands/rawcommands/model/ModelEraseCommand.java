...
/**
 * Model.Erase &mdash; pfcModel.
 *
 * <pre>
 * void Erase() throws jxthrowable
 * </pre>
 */
public final class ModelEraseCommand implements Command {

    @Override public String name() { return "Model.Erase"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Model.Erase \u2014 pfcModel")
