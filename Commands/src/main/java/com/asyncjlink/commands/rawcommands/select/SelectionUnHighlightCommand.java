...
/**
 * Selection.UnHighlight &mdash; pfcSelect.
 *
 * <pre>
 * void UnHighlight() throws jxthrowable
 * </pre>
 */
public final class SelectionUnHighlightCommand implements Command {

    @Override public String name() { return "Selection.UnHighlight"; }
    @Override public String jlinkPackage() { return "pfcSelect"; }
    @Override public String receiverType() { return "Selection"; }
    @Override public String signature() { return "void UnHighlight() throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Selection.UnHighlight \u2014 pfcSelect")
