...
/**
 * Display.SetCurrentGraphicsColor &mdash; pfcDisplay.
 *
 * <pre>
 * void SetCurrentGraphicsColor(StdColor) throws jxthrowable
 * </pre>
 */
public final class DisplaySetCurrentGraphicsColorCommand implements Command {

    @Override public String name() { return "Display.SetCurrentGraphicsColor"; }
    @Override public String jlinkPackage() { return "pfcDisplay"; }
    @Override public String receiverType() { return "Display"; }
    @Override public String signature() { return "void SetCurrentGraphicsColor(StdColor) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Display.SetCurrentGraphicsColor \u2014 pfcDisplay")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        target.SetCurrentGraphicsColor(stdColor);
        return Marshal.ok();
    }
}
