...
/**
 * Material.SetHardness &mdash; pfcPart.
 *
 * <pre>
 * void SetHardness(double) throws jxthrowable
 * </pre>
 */
public final class MaterialSetHardnessCommand implements Command {

    @Override public String name() { return "Material.SetHardness"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void SetHardness(double) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetHardness \u2014 pfcPart")
