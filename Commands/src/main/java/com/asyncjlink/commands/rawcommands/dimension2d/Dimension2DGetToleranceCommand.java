...
/**
 * Dimension2D.GetTolerance &mdash; pfcDimension2D.
 *
 * <pre>
 * DimTolerance GetTolerance() throws jxthrowable
 * </pre>
 */
public final class Dimension2DGetToleranceCommand implements Command {

    @Override public String name() { return "Dimension2D.GetTolerance"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Dimension2D.GetTolerance \u2014 pfcDimension2D")
