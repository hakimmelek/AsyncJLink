...
/**
 * ExternalDataClass.GetName &mdash; pfcExternal.
 *
 * <pre>
 * String GetName() throws jxthrowable
 * </pre>
 */
public final class ExternalDataClassGetNameCommand implements Command {

    @Override public String name() { return "ExternalDataClass.GetName"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("ExternalDataClass.GetName \u2014 pfcExternal")
