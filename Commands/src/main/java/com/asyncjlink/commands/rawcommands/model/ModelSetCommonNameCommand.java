...
/**
 * Model.SetCommonName &mdash; pfcModel.
 *
 * <pre>
 * void SetCommonName(String) throws jxthrowable
 * </pre>
 */
public final class ModelSetCommonNameCommand implements Command {

    @Override public String name() { return "Model.SetCommonName"; }
    @Override public String jlinkPackage() { return "pfcModel"; }
    @Override public String receiverType() { return "Model"; }
    @Override public String signature() { return "void SetCommonName(String) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Model.SetCommonName \u2014 pfcModel")
