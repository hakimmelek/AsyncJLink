...
/**
 * Quilt.GetIsVisible &mdash; pfcGeometry.
 *
 * <pre>
 * boolean GetIsVisible() throws jxthrowable
 * </pre>
 */
public final class QuiltGetIsVisibleCommand implements Command {

    @Override public String name() { return "Quilt.GetIsVisible"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Quilt.GetIsVisible \u2014 pfcGeometry")
