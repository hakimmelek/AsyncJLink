...
/**
 * FamilyMember.CreateTolPlusColumn &mdash; pfcFamily.
 *
 * <pre>
 * FamColTolPlus CreateTolPlusColumn(Dimension) throws jxthrowable
 * </pre>
 */
public final class FamilyMemberCreateTolPlusColumnCommand implements Command {

    @Override public String name() { return "FamilyMember.CreateTolPlusColumn"; }
    @Override public String jlinkPackage() { return "pfcFamily"; }
    @Override public String receiverType() { return "FamilyMember"; }
    @Override public String signature() { return "FamColTolPlus CreateTolPlusColumn(Dimension) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("FamilyMember.CreateTolPlusColumn \u2014 pfcFamily")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.CreateTolPlusColumn(dimension), "FamColTolPlus");
    }
}
