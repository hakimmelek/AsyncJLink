...
/**
 * GeomCurve.EvalParameter &mdash; pfcGeometry.
 *
 * <pre>
 * double EvalParameter(Point3D) throws jxthrowable
 * </pre>
 */
public final class GeomCurveEvalParameterCommand implements Command {

    @Override public String name() { return "GeomCurve.EvalParameter"; }
    @Override public String jlinkPackage() { return "pfcGeometry"; }
    @Override public String receiverType() { return "GeomCurve"; }
    @Override public String signature() { return "double EvalParameter(Point3D) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("GeomCurve.EvalParameter \u2014 pfcGeometry")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.EvalParameter(point3D), "double");
    }
}
