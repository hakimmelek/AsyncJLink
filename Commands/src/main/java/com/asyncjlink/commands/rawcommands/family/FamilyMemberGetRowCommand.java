...
/**
 * FamilyMember.GetRow &mdash; pfcFamily.
 *
 * <pre>
 * FamilyTableRow GetRow(String) throws jxthrowable
 * </pre>
 */
public final class FamilyMemberGetRowCommand implements Command {

    @Override public String name() { return "FamilyMember.GetRow"; }
    @Override public String jlinkPackage() { return "pfcFamily"; }
    @Override public String receiverType() { return "FamilyMember"; }
    @Override public String signature() { return "FamilyTableRow GetRow(String) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("FamilyMember.GetRow \u2014 pfcFamily")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.GetRow(value), "FamilyTableRow");
    }
}
