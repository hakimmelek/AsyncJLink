...
/**
 * ModelItemOwner.ListItems &mdash; pfcModelItem.
 *
 * <pre>
 * ModelItems ListItems(ModelItemType) throws jxthrowable
 * </pre>
 */
public final class ModelItemOwnerListItemsCommand implements Command {

    @Override public String name() { return "ModelItemOwner.ListItems"; }
    @Override public String jlinkPackage() { return "pfcModelItem"; }
    @Override public String receiverType() { return "ModelItemOwner"; }
    @Override public String signature() { return "ModelItems ListItems(ModelItemType) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("ModelItemOwner.ListItems \u2014 pfcModelItem")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.ListItems(modelItemType), "ModelItems");
    }
}
