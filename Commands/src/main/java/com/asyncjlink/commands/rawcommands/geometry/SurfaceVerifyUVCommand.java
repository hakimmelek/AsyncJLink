...
/**
 * Surface.VerifyUV &mdash; pfcGeometry.
 *
 * <pre>
 * Placement VerifyUV(UVParams) throws jxthrowable
 * </pre>
 */
public final class SurfaceVerifyUVCommand implements Command {

    @Override public String name() { return "Surface.VerifyUV"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Surface.VerifyUV \u2014 pfcGeometry")
