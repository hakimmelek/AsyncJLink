...
/**
 * DetailEntityItem.Erase &mdash; pfcDetail.
 *
 * <pre>
 * void Erase() throws jxthrowable
 * </pre>
 */
public final class DetailEntityItemEraseCommand implements Command {

    @Override public String name() { return "DetailEntityItem.Erase"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("DetailEntityItem.Erase \u2014 pfcDetail")
