...
/**
 * BaseDimension.GetSymbol &mdash; pfcDimension.
 *
 * <pre>
 * String GetSymbol() throws jxthrowable
 * </pre>
 */
public final class BaseDimensionGetSymbolCommand implements Command {

    @Override public String name() { return "BaseDimension.GetSymbol"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("BaseDimension.GetSymbol \u2014 pfcDimension")
