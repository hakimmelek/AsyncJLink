...
/**
 * Material.Save &mdash; pfcPart.
 *
 * <pre>
 * void Save(String) throws jxthrowable
 * </pre>
 */
public final class MaterialSaveCommand implements Command {

    @Override public String name() { return "Material.Save"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void Save(String) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.Save \u2014 pfcPart")
