...
/**
 * Table.DeleteColumn &mdash; pfcTable.
 *
 * <pre>
 * void DeleteColumn(int, Boolean) throws jxthrowable
 * </pre>
 */
public final class TableDeleteColumnCommand implements Command {

    @Override public String name() { return "Table.DeleteColumn"; }
    @Override public String jlinkPackage() { return "pfcTable"; }
    @Override public String receiverType() { return "Table"; }
    @Override public String signature() { return "void DeleteColumn(int, Boolean) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Table.DeleteColumn \u2014 pfcTable")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        target.DeleteColumn(value, flag);
        return Marshal.ok();
    }
}
