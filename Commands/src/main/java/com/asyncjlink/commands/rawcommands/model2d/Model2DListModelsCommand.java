...
/**
 * Model2D.ListModels &mdash; pfcModel2D.
 *
 * <pre>
 * Models ListModels() throws jxthrowable
 * </pre>
 */
public final class Model2DListModelsCommand implements Command {

    @Override public String name() { return "Model2D.ListModels"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Model2D.ListModels \u2014 pfcModel2D")
