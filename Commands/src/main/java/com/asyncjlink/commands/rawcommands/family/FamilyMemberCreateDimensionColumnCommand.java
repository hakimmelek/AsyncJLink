...
/**
 * FamilyMember.CreateDimensionColumn &mdash; pfcFamily.
 *
 * <pre>
 * FamColDimension CreateDimensionColumn(Dimension) throws jxthrowable
 * </pre>
 */
public final class FamilyMemberCreateDimensionColumnCommand implements Command {

    @Override public String name() { return "FamilyMember.CreateDimensionColumn"; }
    @Override public String jlinkPackage() { return "pfcFamily"; }
    @Override public String receiverType() { return "FamilyMember"; }
    @Override public String signature() { return "FamColDimension CreateDimensionColumn(Dimension) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("FamilyMember.CreateDimensionColumn \u2014 pfcFamily")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.CreateDimensionColumn(dimension), "FamColDimension");
    }
}
