...
/**
 * Material.SetCrossHatchFile &mdash; pfcPart.
 *
 * <pre>
 * void SetCrossHatchFile(String) throws jxthrowable
 * </pre>
 */
public final class MaterialSetCrossHatchFileCommand implements Command {

    @Override public String name() { return "Material.SetCrossHatchFile"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void SetCrossHatchFile(String) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetCrossHatchFile \u2014 pfcPart")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        target.SetCrossHatchFile(value);
        return Marshal.ok();
    }
}
