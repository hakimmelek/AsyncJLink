...
/**
 * Dimension2D.SetLocation &mdash; pfcDimension2D.
 *
 * <pre>
 * void SetLocation(Point3D) throws jxthrowable
 * </pre>
 */
public final class Dimension2DSetLocationCommand implements Command {

    @Override public String name() { return "Dimension2D.SetLocation"; }
    @Override public String jlinkPackage() { return "pfcDimension2D"; }
    @Override public String receiverType() { return "Dimension2D"; }
    @Override public String signature() { return "void SetLocation(Point3D) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Dimension2D.SetLocation \u2014 pfcDimension2D")
