...
/**
 * Surface.GetFeature &mdash; pfcGeometry.
 *
 * <pre>
 * Feature GetFeature() throws jxthrowable
 * </pre>
 */
public final class SurfaceGetFeatureCommand implements Command {

    @Override public String name() { return "Surface.GetFeature"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Surface.GetFeature \u2014 pfcGeometry")
