...
/**
 * ComponentFeat.SetPosition &mdash; pfcComponentFeat.
 *
 * <pre>
 * void SetPosition(Transform3D) throws jxthrowable
 * </pre>
 */
public final class ComponentFeatSetPositionCommand implements Command {

    @Override public String name() { return "ComponentFeat.SetPosition"; }
    @Override public String jlinkPackage() { return "pfcComponentFeat"; }
    @Override public String receiverType() { return "ComponentFeat"; }
    @Override public String signature() { return "void SetPosition(Transform3D) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("ComponentFeat.SetPosition \u2014 pfcComponentFeat")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        target.SetPosition(transform3D);
        return Marshal.ok();
    }
}
