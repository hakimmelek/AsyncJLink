...
/**
 * Surface.EvalDiameter &mdash; pfcGeometry.
 *
 * <pre>
 * double EvalDiameter(UVParams) throws jxthrowable
 * </pre>
 */
public final class SurfaceEvalDiameterCommand implements Command {

    @Override public String name() { return "Surface.EvalDiameter"; }
    @Override public String jlinkPackage() { return "pfcGeometry"; }
    @Override public String receiverType() { return "Surface"; }
    @Override public String signature() { return "double EvalDiameter(UVParams) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Surface.EvalDiameter \u2014 pfcGeometry")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.EvalDiameter(uvParams), "double");
    }
}
