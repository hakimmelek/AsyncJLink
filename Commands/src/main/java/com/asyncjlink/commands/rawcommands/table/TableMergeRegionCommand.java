...
/**
 * Table.MergeRegion &mdash; pfcTable.
 *
 * <pre>
 * void MergeRegion(TableCell, TableCell, Boolean) throws jxthrowable
 * </pre>
 */
public final class TableMergeRegionCommand implements Command {

    @Override public String name() { return "Table.MergeRegion"; }
    @Override public String jlinkPackage() { return "pfcTable"; }
    @Override public String receiverType() { return "Table"; }
    @Override public String signature() { return "void MergeRegion(TableCell, TableCell, Boolean) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Table.MergeRegion \u2014 pfcTable")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        target.MergeRegion(tableCell1, tableCell2, flag);
        return Marshal.ok();
    }
}
