...
/**
 * XSection.Regenerate &mdash; pfcXSection.
 *
 * <pre>
 * void Regenerate() throws jxthrowable
 * </pre>
 */
public final class XSectionRegenerateCommand implements Command {

    @Override public String name() { return "XSection.Regenerate"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("XSection.Regenerate \u2014 pfcXSection")
