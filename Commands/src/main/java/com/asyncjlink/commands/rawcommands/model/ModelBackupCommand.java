...
/**
 * Model.Backup &mdash; pfcModel.
 *
 * <pre>
 * void Backup(ModelDescriptor) throws jxthrowable
 * </pre>
 */
public final class ModelBackupCommand implements Command {

    @Override public String name() { return "Model.Backup"; }
    @Override public String jlinkPackage() { return "pfcModel"; }
    @Override public String receiverType() { return "Model"; }
    @Override public String signature() { return "void Backup(ModelDescriptor) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Model.Backup \u2014 pfcModel")
