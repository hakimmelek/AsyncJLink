...
/**
 * FamilyMember.CreateTolPlusMinusColumn &mdash; pfcFamily.
 *
 * <pre>
 * FamColTolPlusMinus CreateTolPlusMinusColumn(Dimension) throws jxthrowable
 * </pre>
 */
public final class FamilyMemberCreateTolPlusMinusColumnCommand implements Command {

    @Override public String name() { return "FamilyMember.CreateTolPlusMinusColumn"; }
    @Override public String jlinkPackage() { return "pfcFamily"; }
    @Override public String receiverType() { return "FamilyMember"; }
    @Override public String signature() { return "FamColTolPlusMinus CreateTolPlusMinusColumn(Dimension) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("FamilyMember.CreateTolPlusMinusColumn \u2014 pfcFamily")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.CreateTolPlusMinusColumn(dimension), "FamColTolPlusMinus");
    }
}
