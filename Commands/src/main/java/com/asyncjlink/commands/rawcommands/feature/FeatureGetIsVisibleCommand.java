...
/**
 * Feature.GetIsVisible &mdash; pfcFeature.
 *
 * <pre>
 * boolean GetIsVisible() throws jxthrowable
 * </pre>
 */
public final class FeatureGetIsVisibleCommand implements Command {

    @Override public String name() { return "Feature.GetIsVisible"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Feature.GetIsVisible \u2014 pfcFeature")
