...
/**
 * CriticalDistanceData.SetSurfParam2 &mdash; pfcInterference.
 *
 * <pre>
 * void SetSurfParam2(UVParams) throws jxthrowable
 * </pre>
 */
public final class CriticalDistanceDataSetSurfParam2Command implements Command {

    @Override public String name() { return "CriticalDistanceData.SetSurfParam2"; }
    ...
    @Override public String signature() { return "void SetSurfParam2(UVParams) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("CriticalDistanceData.SetSurfParam2 \u2014 pfcInterference")
