...
/**
 * FeatureGroup.ListMembers &mdash; pfcFeature.
 *
 * <pre>
 * Features ListMembers() throws jxthrowable
 * </pre>
 */
public final class FeatureGroupListMembersCommand implements Command {

    @Override public String name() { return "FeatureGroup.ListMembers"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("FeatureGroup.ListMembers \u2014 pfcFeature")
