...
/**
 * BaseSession.GetMessageContents &mdash; pfcSession.
 *
 * <pre>
 * String GetMessageContents(String, String, stringseq) throws jxthrowable
 * </pre>
 */
public final class BaseSessionGetMessageContentsCommand implements Command {

    @Override public String name() { return "BaseSession.GetMessageContents"; }
    @Override public String jlinkPackage() { return "pfcSession"; }
    @Override public String receiverType() { return "BaseSession"; }
    @Override public String signature() { return "String GetMessageContents(String, String, stringseq) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("BaseSession.GetMessageContents \u2014 pfcSession")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.GetMessageContents(value1, value2, values), "String");
    }
}
