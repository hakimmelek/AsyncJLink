...
/**
 * XSection.Delete &mdash; pfcXSection.
 *
 * <pre>
 * void Delete() throws jxthrowable
 * </pre>
 */
public final class XSectionDeleteCommand implements Command {

    @Override public String name() { return "XSection.Delete"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("XSection.Delete \u2014 pfcXSection")
