...
/**
 * ModelItem.GetName &mdash; pfcModelItem.
 *
 * <pre>
 * String GetName() throws jxthrowable
 * </pre>
 */
public final class ModelItemGetNameCommand implements Command {

    @Override public String name() { return "ModelItem.GetName"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("ModelItem.GetName \u2014 pfcModelItem")
