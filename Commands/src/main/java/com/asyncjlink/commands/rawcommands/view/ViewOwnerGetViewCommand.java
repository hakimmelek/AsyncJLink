...
/**
 * ViewOwner.GetView &mdash; pfcView.
 *
 * <pre>
 * View GetView(String) throws jxthrowable
 * </pre>
 */
public final class ViewOwnerGetViewCommand implements Command {

    @Override public String name() { return "ViewOwner.GetView"; }
    @Override public String jlinkPackage() { return "pfcView"; }
    @Override public String receiverType() { return "ViewOwner"; }
    @Override public String signature() { return "View GetView(String) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("ViewOwner.GetView \u2014 pfcView")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.GetView(value), "View");
    }
}
