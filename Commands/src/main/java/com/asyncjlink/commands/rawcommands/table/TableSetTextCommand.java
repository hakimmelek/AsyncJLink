...
/**
 * Table.SetText &mdash; pfcTable.
 *
 * <pre>
 * void SetText(TableCell, stringseq) throws jxthrowable
 * </pre>
 */
public final class TableSetTextCommand implements Command {

    @Override public String name() { return "Table.SetText"; }
    @Override public String jlinkPackage() { return "pfcTable"; }
    @Override public String receiverType() { return "Table"; }
    @Override public String signature() { return "void SetText(TableCell, stringseq) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Table.SetText \u2014 pfcTable")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        target.SetText(tableCell, values);
        return Marshal.ok();
    }
}
