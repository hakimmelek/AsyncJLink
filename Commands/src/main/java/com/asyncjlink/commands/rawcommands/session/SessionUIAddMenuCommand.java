...
/**
 * Session.UIAddMenu &mdash; pfcSession.
 *
 * <pre>
 * void UIAddMenu(String, String, String, String) throws jxthrowable
 * </pre>
 */
public final class SessionUIAddMenuCommand implements Command {

    @Override public String name() { return "Session.UIAddMenu"; }
    @Override public String jlinkPackage() { return "pfcSession"; }
    @Override public String receiverType() { return "Session"; }
    @Override public String signature() { return "void UIAddMenu(String, String, String, String) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Session.UIAddMenu \u2014 pfcSession")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        target.UIAddMenu(value1, value2, value3, value4);
        return Marshal.ok();
    }
}
