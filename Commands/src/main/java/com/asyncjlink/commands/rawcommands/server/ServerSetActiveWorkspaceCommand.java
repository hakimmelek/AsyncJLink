...
/**
 * Server.SetActiveWorkspace &mdash; pfcServer.
 *
 * <pre>
 * void SetActiveWorkspace(String) throws jxthrowable
 * </pre>
 */
public final class ServerSetActiveWorkspaceCommand implements Command {

    @Override public String name() { return "Server.SetActiveWorkspace"; }
    @Override public String jlinkPackage() { return "pfcServer"; }
    @Override public String receiverType() { return "Server"; }
    @Override public String signature() { return "void SetActiveWorkspace(String) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Server.SetActiveWorkspace \u2014 pfcServer")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        target.SetActiveWorkspace(value);
        return Marshal.ok();
    }
}
