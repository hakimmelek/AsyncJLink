...
/**
 * DeleteOperation.SetKeepEmbeddedDatums &mdash; pfcFeature.
 *
 * <pre>
 * void SetKeepEmbeddedDatums(boolean) throws jxthrowable
 * </pre>
 */
public final class DeleteOperationSetKeepEmbeddedDatumsCommand implements Command {

    @Override public String name() { return "DeleteOperation.SetKeepEmbeddedDatums"; }
    @Override public String jlinkPackage() { return "pfcFeature"; }
    @Override public String receiverType() { return "DeleteOperation"; }
    @Override public String signature() { return "void SetKeepEmbeddedDatums(boolean) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("DeleteOperation.SetKeepEmbeddedDatums \u2014 pfcFeature")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        target.SetKeepEmbeddedDatums(flag);
        return Marshal.ok();
    }
}
