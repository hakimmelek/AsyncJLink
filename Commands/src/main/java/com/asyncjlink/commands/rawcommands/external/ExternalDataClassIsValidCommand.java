...
/**
 * ExternalDataClass.IsValid &mdash; pfcExternal.
 *
 * <pre>
 * boolean IsValid() throws jxthrowable
 * </pre>
 */
public final class ExternalDataClassIsValidCommand implements Command {

    @Override public String name() { return "ExternalDataClass.IsValid"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("ExternalDataClass.IsValid \u2014 pfcExternal")
