...
/**
 * Material.SetStressLimTension &mdash; pfcPart.
 *
 * <pre>
 * void SetStressLimTension(double) throws jxthrowable
 * </pre>
 */
public final class MaterialSetStressLimTensionCommand implements Command {

    @Override public String name() { return "Material.SetStressLimTension"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void SetStressLimTension(double) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetStressLimTension \u2014 pfcPart")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        target.SetStressLimTension(value);
        return Marshal.ok();
    }
}
