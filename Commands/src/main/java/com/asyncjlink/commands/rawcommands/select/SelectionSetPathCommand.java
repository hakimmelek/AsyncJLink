...
/**
 * Selection.SetPath &mdash; pfcSelect.
 *
 * <pre>
 * void SetPath(ComponentPath) throws jxthrowable
 * </pre>
 */
public final class SelectionSetPathCommand implements Command {

    @Override public String name() { return "Selection.SetPath"; }
    @Override public String jlinkPackage() { return "pfcSelect"; }
    @Override public String receiverType() { return "Selection"; }
    @Override public String signature() { return "void SetPath(ComponentPath) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Selection.SetPath \u2014 pfcSelect")
