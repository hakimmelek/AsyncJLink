...
/**
 * FamilyMember.CreateComponentColumn &mdash; pfcFamily.
 *
 * <pre>
 * FamColComp CreateComponentColumn(Feature) throws jxthrowable
 * </pre>
 */
public final class FamilyMemberCreateComponentColumnCommand implements Command {

    @Override public String name() { return "FamilyMember.CreateComponentColumn"; }
    @Override public String jlinkPackage() { return "pfcFamily"; }
    @Override public String receiverType() { return "FamilyMember"; }
    @Override public String signature() { return "FamColComp CreateComponentColumn(Feature) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("FamilyMember.CreateComponentColumn \u2014 pfcFamily")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.CreateComponentColumn(feature), "FamColComp");
    }
}
