...
/**
 * View2D.SetName &mdash; pfcView2D.
 *
 * <pre>
 * void SetName(String) throws jxthrowable
 * </pre>
 */
public final class View2DSetNameCommand implements Command {

    @Override public String name() { return "View2D.SetName"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("View2D.SetName \u2014 pfcView2D")
