...
/**
 * BaseSession.LoadProToolkitDll &mdash; pfcSession.
 *
 * <pre>
 * Dll LoadProToolkitDll(String, String, String, boolean) throws jxthrowable
 * </pre>
 */
public final class BaseSessionLoadProToolkitDllCommand implements Command {

    @Override public String name() { return "BaseSession.LoadProToolkitDll"; }
    @Override public String jlinkPackage() { return "pfcSession"; }
    @Override public String receiverType() { return "BaseSession"; }
    @Override public String signature() { return "Dll LoadProToolkitDll(String, String, String, boolean) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("BaseSession.LoadProToolkitDll \u2014 pfcSession")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.LoadProToolkitDll(value1, value2, value3, flag), "Dll");
    }
}
