...
/**
 * Parameter.Reorder &mdash; pfcModelItem.
 *
 * <pre>
 * void Reorder(Parameter) throws jxthrowable
 * </pre>
 */
public final class ParameterReorderCommand implements Command {

    @Override public String name() { return "Parameter.Reorder"; }
    @Override public String jlinkPackage() { return "pfcModelItem"; }
    @Override public String receiverType() { return "Parameter"; }
    @Override public String signature() { return "void Reorder(Parameter) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Parameter.Reorder \u2014 pfcModelItem")
