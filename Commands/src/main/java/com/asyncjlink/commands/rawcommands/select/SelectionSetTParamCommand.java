...
/**
 * Selection.SetTParam &mdash; pfcSelect.
 *
 * <pre>
 * void SetTParam(Double) throws jxthrowable
 * </pre>
 */
public final class SelectionSetTParamCommand implements Command {

    @Override public String name() { return "Selection.SetTParam"; }
    @Override public String jlinkPackage() { return "pfcSelect"; }
    @Override public String receiverType() { return "Selection"; }
    @Override public String signature() { return "void SetTParam(Double) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Selection.SetTParam \u2014 pfcSelect")
