...
/**
 * Selection.GetPoint &mdash; pfcSelect.
 *
 * <pre>
 * Point3D GetPoint() throws jxthrowable
 * </pre>
 */
public final class SelectionGetPointCommand implements Command {

    @Override public String name() { return "Selection.GetPoint"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Selection.GetPoint \u2014 pfcSelect")
