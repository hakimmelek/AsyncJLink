...
/**
 * ExternalDataAccess.LoadAll &mdash; pfcExternal.
 *
 * <pre>
 * void LoadAll() throws jxthrowable
 * </pre>
 */
public final class ExternalDataAccessLoadAllCommand implements Command {

    @Override public String name() { return "ExternalDataAccess.LoadAll"; }
    @Override public String jlinkPackage() { return "pfcExternal"; }
    @Override public String receiverType() { return "ExternalDataAccess"; }
    @Override public String signature() { return "void LoadAll() throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("ExternalDataAccess.LoadAll \u2014 pfcExternal")
