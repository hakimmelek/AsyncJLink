...
/**
 * ExternalDataSlot.IsValid &mdash; pfcExternal.
 *
 * <pre>
 * boolean IsValid() throws jxthrowable
 * </pre>
 */
public final class ExternalDataSlotIsValidCommand implements Command {

    @Override public String name() { return "ExternalDataSlot.IsValid"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("ExternalDataSlot.IsValid \u2014 pfcExternal")
