...
/**
 * Table.Erase &mdash; pfcTable.
 *
 * <pre>
 * void Erase() throws jxthrowable
 * </pre>
 */
public final class TableEraseCommand implements Command {

    @Override public String name() { return "Table.Erase"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Table.Erase \u2014 pfcTable")
