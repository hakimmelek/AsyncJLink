...
/**
 * Solid.DeleteSimpRep &mdash; pfcSolid.
 *
 * <pre>
 * void DeleteSimpRep(SimpRep) throws jxthrowable
 * </pre>
 */
public final class SolidDeleteSimpRepCommand implements Command {

    @Override public String name() { return "Solid.DeleteSimpRep"; }
    @Override public String jlinkPackage() { return "pfcSolid"; }
    @Override public String receiverType() { return "Solid"; }
    @Override public String signature() { return "void DeleteSimpRep(SimpRep) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Solid.DeleteSimpRep \u2014 pfcSolid")
