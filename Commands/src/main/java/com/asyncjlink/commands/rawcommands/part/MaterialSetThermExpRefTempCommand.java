...
/**
 * Material.SetThermExpRefTemp &mdash; pfcPart.
 *
 * <pre>
 * void SetThermExpRefTemp(double) throws jxthrowable
 * </pre>
 */
public final class MaterialSetThermExpRefTempCommand implements Command {

    @Override public String name() { return "Material.SetThermExpRefTemp"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void SetThermExpRefTemp(double) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetThermExpRefTemp \u2014 pfcPart")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        target.SetThermExpRefTemp(value);
        return Marshal.ok();
    }
}
