...
/**
 * Material.SetStressLimShear &mdash; pfcPart.
 *
 * <pre>
 * void SetStressLimShear(double) throws jxthrowable
 * </pre>
 */
public final class MaterialSetStressLimShearCommand implements Command {

    @Override public String name() { return "Material.SetStressLimShear"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void SetStressLimShear(double) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetStressLimShear \u2014 pfcPart")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        target.SetStressLimShear(value);
        return Marshal.ok();
    }
}
