...
/**
 * CriticalDistanceData.SetSurfParam1 &mdash; pfcInterference.
 *
 * <pre>
 * void SetSurfParam1(UVParams) throws jxthrowable
 * </pre>
 */
public final class CriticalDistanceDataSetSurfParam1Command implements Command {

    @Override public String name() { return "CriticalDistanceData.SetSurfParam1"; }
    ...
    @Override public String signature() { return "void SetSurfParam1(UVParams) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("CriticalDistanceData.SetSurfParam1 \u2014 pfcInterference")
