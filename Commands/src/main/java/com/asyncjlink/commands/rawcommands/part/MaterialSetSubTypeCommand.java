...
/**
 * Material.SetSubType &mdash; pfcPart.
 *
 * <pre>
 * void SetSubType(String) throws jxthrowable
 * </pre>
 */
public final class MaterialSetSubTypeCommand implements Command {

    @Override public String name() { return "Material.SetSubType"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void SetSubType(String) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetSubType \u2014 pfcPart")
