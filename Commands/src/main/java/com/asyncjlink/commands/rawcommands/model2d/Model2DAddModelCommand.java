...
/**
 * Model2D.AddModel &mdash; pfcModel2D.
 *
 * <pre>
 * void AddModel(Model) throws jxthrowable
 * </pre>
 */
public final class Model2DAddModelCommand implements Command {

    @Override public String name() { return "Model2D.AddModel"; }
    @Override public String jlinkPackage() { return "pfcModel2D"; }
    @Override public String receiverType() { return "Model2D"; }
    @Override public String signature() { return "void AddModel(Model) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Model2D.AddModel \u2014 pfcModel2D")
