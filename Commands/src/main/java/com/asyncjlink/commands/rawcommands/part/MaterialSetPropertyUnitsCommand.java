...
/**
 * Material.SetPropertyUnits &mdash; pfcPart.
 *
 * <pre>
 * void SetPropertyUnits(MaterialPropertyType, String, Boolean) throws jxthrowable
 * </pre>
 */
public final class MaterialSetPropertyUnitsCommand implements Command {

    @Override public String name() { return "Material.SetPropertyUnits"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void SetPropertyUnits(MaterialPropertyType, String, Boolean) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetPropertyUnits \u2014 pfcPart")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        target.SetPropertyUnits(materialPropertyType, value, flag);
        return Marshal.ok();
    }
}
