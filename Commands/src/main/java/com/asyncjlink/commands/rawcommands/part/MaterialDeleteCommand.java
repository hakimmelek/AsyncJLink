...
/**
 * Material.Delete &mdash; pfcPart.
 *
 * <pre>
 * void Delete() throws jxthrowable
 * </pre>
 */
public final class MaterialDeleteCommand implements Command {

    @Override public String name() { return "Material.Delete"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.Delete \u2014 pfcPart")
