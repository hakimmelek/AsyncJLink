...
/**
 * CriticalDistanceData.SetCriticalPoint1 &mdash; pfcInterference.
 *
 * <pre>
 * void SetCriticalPoint1(Point3D) throws jxthrowable
 * </pre>
 */
public final class CriticalDistanceDataSetCriticalPoint1Command implements Command {

    @Override public String name() { return "CriticalDistanceData.SetCriticalPoint1"; }
    ...
    @Override public String signature() { return "void SetCriticalPoint1(Point3D) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("CriticalDistanceData.SetCriticalPoint1 \u2014 pfcInterference")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        target.SetCriticalPoint1(point3D);
        return Marshal.ok();
    }
}
