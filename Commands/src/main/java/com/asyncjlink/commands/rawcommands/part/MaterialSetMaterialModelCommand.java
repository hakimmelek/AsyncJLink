...
/**
 * Material.SetMaterialModel &mdash; pfcPart.
 *
 * <pre>
 * void SetMaterialModel(String) throws jxthrowable
 * </pre>
 */
public final class MaterialSetMaterialModelCommand implements Command {

    @Override public String name() { return "Material.SetMaterialModel"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void SetMaterialModel(String) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetMaterialModel \u2014 pfcPart")
