...
/**
 * Assembly.UnExplode &mdash; pfcAssembly.
 *
 * <pre>
 * void UnExplode() throws jxthrowable
 * </pre>
 */
public final class AssemblyUnExplodeCommand implements Command {

    @Override public String name() { return "Assembly.UnExplode"; }
    @Override public String jlinkPackage() { return "pfcAssembly"; }
    @Override public String receiverType() { return "Assembly"; }
    @Override public String signature() { return "void UnExplode() throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Assembly.UnExplode \u2014 pfcAssembly")
