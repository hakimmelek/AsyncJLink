...
/**
 * ViewOwner.RetrieveView &mdash; pfcView.
 *
 * <pre>
 * View RetrieveView(String) throws jxthrowable
 * </pre>
 */
public final class ViewOwnerRetrieveViewCommand implements Command {

    @Override public String name() { return "ViewOwner.RetrieveView"; }
    @Override public String jlinkPackage() { return "pfcView"; }
    @Override public String receiverType() { return "ViewOwner"; }
    @Override public String signature() { return "View RetrieveView(String) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("ViewOwner.RetrieveView \u2014 pfcView")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.RetrieveView(value), "View");
    }
}
