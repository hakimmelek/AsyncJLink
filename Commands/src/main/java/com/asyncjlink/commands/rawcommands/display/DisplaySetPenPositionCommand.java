...
/**
 * Display.SetPenPosition &mdash; pfcDisplay.
 *
 * <pre>
 * void SetPenPosition(Point3D) throws jxthrowable
 * </pre>
 */
public final class DisplaySetPenPositionCommand implements Command {

    @Override public String name() { return "Display.SetPenPosition"; }
    @Override public String jlinkPackage() { return "pfcDisplay"; }
    @Override public String receiverType() { return "Display"; }
    @Override public String signature() { return "void SetPenPosition(Point3D) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Display.SetPenPosition \u2014 pfcDisplay")
