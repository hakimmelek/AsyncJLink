...
/**
 * FamilyTableRow.SetIsLocked &mdash; pfcFamily.
 *
 * <pre>
 * void SetIsLocked(boolean) throws jxthrowable
 * </pre>
 */
public final class FamilyTableRowSetIsLockedCommand implements Command {

    @Override public String name() { return "FamilyTableRow.SetIsLocked"; }
    @Override public String jlinkPackage() { return "pfcFamily"; }
    @Override public String receiverType() { return "FamilyTableRow"; }
    @Override public String signature() { return "void SetIsLocked(boolean) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("FamilyTableRow.SetIsLocked \u2014 pfcFamily")
