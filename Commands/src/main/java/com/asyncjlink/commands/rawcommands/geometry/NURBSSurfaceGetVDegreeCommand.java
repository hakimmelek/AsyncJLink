...
/**
 * NURBSSurface.GetVDegree &mdash; pfcGeometry.
 *
 * <pre>
 * int GetVDegree() throws jxthrowable
 * </pre>
 */
public final class NURBSSurfaceGetVDegreeCommand implements Command {

    @Override public String name() { return "NURBSSurface.GetVDegree"; }
    @Override public String jlinkPackage() { return "pfcGeometry"; }
    @Override public String receiverType() { return "NURBSSurface"; }
    @Override public String signature() { return "int GetVDegree() throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("NURBSSurface.GetVDegree \u2014 pfcGeometry")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.GetVDegree(), "int");
    }
}
