...
/**
 * ComponentFeat.SetIsPlaced &mdash; pfcComponentFeat.
 *
 * <pre>
 * void SetIsPlaced(boolean) throws jxthrowable
 * </pre>
 */
public final class ComponentFeatSetIsPlacedCommand implements Command {

    @Override public String name() { return "ComponentFeat.SetIsPlaced"; }
    @Override public String jlinkPackage() { return "pfcComponentFeat"; }
    @Override public String receiverType() { return "ComponentFeat"; }
    @Override public String signature() { return "void SetIsPlaced(boolean) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("ComponentFeat.SetIsPlaced \u2014 pfcComponentFeat")
