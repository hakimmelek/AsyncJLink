...
/**
 * Material.SetFatigueMaterialType &mdash; pfcPart.
 *
 * <pre>
 * void SetFatigueMaterialType(String) throws jxthrowable
 * </pre>
 */
public final class MaterialSetFatigueMaterialTypeCommand implements Command {

    @Override public String name() { return "Material.SetFatigueMaterialType"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void SetFatigueMaterialType(String) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetFatigueMaterialType \u2014 pfcPart")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        target.SetFatigueMaterialType(value);
        return Marshal.ok();
    }
}
