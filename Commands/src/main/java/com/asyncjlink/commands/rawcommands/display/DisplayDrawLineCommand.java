...
/**
 * Display.DrawLine &mdash; pfcDisplay.
 *
 * <pre>
 * void DrawLine(Point3D) throws jxthrowable
 * </pre>
 */
public final class DisplayDrawLineCommand implements Command {

    @Override public String name() { return "Display.DrawLine"; }
    @Override public String jlinkPackage() { return "pfcDisplay"; }
    @Override public String receiverType() { return "Display"; }
    @Override public String signature() { return "void DrawLine(Point3D) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Display.DrawLine \u2014 pfcDisplay")
