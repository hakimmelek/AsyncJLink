...
/**
 * Model.GetIsModified &mdash; pfcModel.
 *
 * <pre>
 * boolean GetIsModified() throws jxthrowable
 * </pre>
 */
public final class ModelGetIsModifiedCommand implements Command {

    @Override public String name() { return "Model.GetIsModified"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Model.GetIsModified \u2014 pfcModel")
