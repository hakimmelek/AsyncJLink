...
/**
 * XSection.Display &mdash; pfcXSection.
 *
 * <pre>
 * void Display() throws jxthrowable
 * </pre>
 */
public final class XSectionDisplayCommand implements Command {

    @Override public String name() { return "XSection.Display"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("XSection.Display \u2014 pfcXSection")
