...
/**
 * ParameterOwner.CreateParam &mdash; pfcModelItem.
 *
 * <pre>
 * Parameter CreateParam(String, ParamValue) throws jxthrowable
 * </pre>
 */
public final class ParameterOwnerCreateParamCommand implements Command {

    @Override public String name() { return "ParameterOwner.CreateParam"; }
    @Override public String jlinkPackage() { return "pfcModelItem"; }
    @Override public String receiverType() { return "ParameterOwner"; }
    @Override public String signature() { return "Parameter CreateParam(String, ParamValue) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("ParameterOwner.CreateParam \u2014 pfcModelItem")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.CreateParam(value, paramValue), "Parameter");
    }
}
