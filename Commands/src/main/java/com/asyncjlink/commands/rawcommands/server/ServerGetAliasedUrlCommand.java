...
/**
 * Server.GetAliasedUrl &mdash; pfcServer.
 *
 * <pre>
 * String GetAliasedUrl(String) throws jxthrowable
 * </pre>
 */
public final class ServerGetAliasedUrlCommand implements Command {

    @Override public String name() { return "Server.GetAliasedUrl"; }
    @Override public String jlinkPackage() { return "pfcServer"; }
    @Override public String receiverType() { return "Server"; }
    @Override public String signature() { return "String GetAliasedUrl(String) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Server.GetAliasedUrl \u2014 pfcServer")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.GetAliasedUrl(value), "String");
    }
}
