...
/**
 * Unit.GetName &mdash; pfcUnits.
 *
 * <pre>
 * String GetName() throws jxthrowable
 * </pre>
 */
public final class UnitGetNameCommand implements Command {

    @Override public String name() { return "Unit.GetName"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Unit.GetName \u2014 pfcUnits")
