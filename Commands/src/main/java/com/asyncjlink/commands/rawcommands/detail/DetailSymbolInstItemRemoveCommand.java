...
/**
 * DetailSymbolInstItem.Remove &mdash; pfcDetail.
 *
 * <pre>
 * void Remove() throws jxthrowable
 * </pre>
 */
public final class DetailSymbolInstItemRemoveCommand implements Command {

    @Override public String name() { return "DetailSymbolInstItem.Remove"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("DetailSymbolInstItem.Remove \u2014 pfcDetail")
