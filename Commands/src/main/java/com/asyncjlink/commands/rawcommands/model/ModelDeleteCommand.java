...
/**
 * Model.Delete &mdash; pfcModel.
 *
 * <pre>
 * void Delete() throws jxthrowable
 * </pre>
 */
public final class ModelDeleteCommand implements Command {

    @Override public String name() { return "Model.Delete"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Model.Delete \u2014 pfcModel")
