...
/**
 * Material.SetDescription &mdash; pfcPart.
 *
 * <pre>
 * void SetDescription(String) throws jxthrowable
 * </pre>
 */
public final class MaterialSetDescriptionCommand implements Command {

    @Override public String name() { return "Material.SetDescription"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetDescription \u2014 pfcPart")
