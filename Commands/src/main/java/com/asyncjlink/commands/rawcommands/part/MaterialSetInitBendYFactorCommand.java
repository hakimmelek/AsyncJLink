...
/**
 * Material.SetInitBendYFactor &mdash; pfcPart.
 *
 * <pre>
 * void SetInitBendYFactor(double) throws jxthrowable
 * </pre>
 */
public final class MaterialSetInitBendYFactorCommand implements Command {

    @Override public String name() { return "Material.SetInitBendYFactor"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void SetInitBendYFactor(double) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetInitBendYFactor \u2014 pfcPart")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        target.SetInitBendYFactor(value);
        return Marshal.ok();
    }
}
