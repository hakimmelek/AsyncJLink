...
/**
 * GeomCurve.GetFeature &mdash; pfcGeometry.
 *
 * <pre>
 * Feature GetFeature() throws jxthrowable
 * </pre>
 */
public final class GeomCurveGetFeatureCommand implements Command {

    @Override public String name() { return "GeomCurve.GetFeature"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("GeomCurve.GetFeature \u2014 pfcGeometry")
