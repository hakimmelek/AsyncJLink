...
/**
 * View2D.GetName &mdash; pfcView2D.
 *
 * <pre>
 * String GetName() throws jxthrowable
 * </pre>
 */
public final class View2DGetNameCommand implements Command {

    @Override public String name() { return "View2D.GetName"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("View2D.GetName \u2014 pfcView2D")
