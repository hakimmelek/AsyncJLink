...
/**
 * Server.Unregister &mdash; pfcServer.
 *
 * <pre>
 * void Unregister() throws jxthrowable
 * </pre>
 */
public final class ServerUnregisterCommand implements Command {

    @Override public String name() { return "Server.Unregister"; }
    @Override public String jlinkPackage() { return "pfcServer"; }
    @Override public String receiverType() { return "Server"; }
    @Override public String signature() { return "void Unregister() throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Server.Unregister \u2014 pfcServer")
