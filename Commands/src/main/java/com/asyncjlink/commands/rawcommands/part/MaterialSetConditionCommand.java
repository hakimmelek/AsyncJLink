...
/**
 * Material.SetCondition &mdash; pfcPart.
 *
 * <pre>
 * void SetCondition(String) throws jxthrowable
 * </pre>
 */
public final class MaterialSetConditionCommand implements Command {

    @Override public String name() { return "Material.SetCondition"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void SetCondition(String) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetCondition \u2014 pfcPart")
