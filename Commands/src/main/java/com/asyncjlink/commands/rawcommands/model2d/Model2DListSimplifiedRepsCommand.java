...
/**
 * Model2D.ListSimplifiedReps &mdash; pfcModel2D.
 *
 * <pre>
 * SimpReps ListSimplifiedReps(Model) throws jxthrowable
 * </pre>
 */
public final class Model2DListSimplifiedRepsCommand implements Command {

    @Override public String name() { return "Model2D.ListSimplifiedReps"; }
    @Override public String jlinkPackage() { return "pfcModel2D"; }
    @Override public String receiverType() { return "Model2D"; }
    @Override public String signature() { return "SimpReps ListSimplifiedReps(Model) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Model2D.ListSimplifiedReps \u2014 pfcModel2D")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.ListSimplifiedReps(model), "SimpReps");
    }
}
