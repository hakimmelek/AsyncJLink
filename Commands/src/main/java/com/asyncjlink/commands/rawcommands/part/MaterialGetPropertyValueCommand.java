...
/**
 * Material.GetPropertyValue &mdash; pfcPart.
 *
 * <pre>
 * MaterialProperty GetPropertyValue(MaterialPropertyType) throws jxthrowable
 * </pre>
 */
public final class MaterialGetPropertyValueCommand implements Command {

    @Override public String name() { return "Material.GetPropertyValue"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "MaterialProperty GetPropertyValue(MaterialPropertyType) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.GetPropertyValue \u2014 pfcPart")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.GetPropertyValue(materialPropertyType), "MaterialProperty");
    }
}
