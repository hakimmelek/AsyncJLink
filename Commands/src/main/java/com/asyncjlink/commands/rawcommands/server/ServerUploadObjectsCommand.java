...
/**
 * Server.UploadObjects &mdash; pfcServer.
 *
 * <pre>
 * void UploadObjects(Model) throws jxthrowable
 * </pre>
 */
public final class ServerUploadObjectsCommand implements Command {

    @Override public String name() { return "Server.UploadObjects"; }
    @Override public String jlinkPackage() { return "pfcServer"; }
    @Override public String receiverType() { return "Server"; }
    @Override public String signature() { return "void UploadObjects(Model) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Server.UploadObjects \u2014 pfcServer")
