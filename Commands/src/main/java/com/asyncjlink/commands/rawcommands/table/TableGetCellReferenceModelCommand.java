...
/**
 * Table.GetCellReferenceModel &mdash; pfcTable.
 *
 * <pre>
 * Model GetCellReferenceModel(TableCell) throws jxthrowable
 * </pre>
 */
public final class TableGetCellReferenceModelCommand implements Command {

    @Override public String name() { return "Table.GetCellReferenceModel"; }
    @Override public String jlinkPackage() { return "pfcTable"; }
    @Override public String receiverType() { return "Table"; }
    @Override public String signature() { return "Model GetCellReferenceModel(TableCell) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Table.GetCellReferenceModel \u2014 pfcTable")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.GetCellReferenceModel(tableCell), "Model");
    }
}
