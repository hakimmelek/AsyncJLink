...
/**
 * DetailGroupItem.Erase &mdash; pfcDetail.
 *
 * <pre>
 * void Erase() throws jxthrowable
 * </pre>
 */
public final class DetailGroupItemEraseCommand implements Command {

    @Override public String name() { return "DetailGroupItem.Erase"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("DetailGroupItem.Erase \u2014 pfcDetail")
