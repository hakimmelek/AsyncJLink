...
/**
 * Session.UICreateMaxPriorityCommand &mdash; pfcSession.
 *
 * <pre>
 * UICommand UICreateMaxPriorityCommand(String, UICommandActionListener) throws jxthrowable
 * </pre>
 *
 * <p>Catalogued but not invocable: it requires a live UICommandActionListener callback.
 */
public final class SessionUICreateMaxPriorityCommandCommand implements Command {

    @Override public String name() { return "Session.UICreateMaxPriorityCommand"; }
    @Override public String jlinkPackage() { return "pfcSession"; }
    @Override public String receiverType() { return "Session"; }
    @Override public String signature() { return "UICommand UICreateMaxPriorityCommand(String, UICommandActionListener) throws jxthrowable"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Session.UICreateMaxPriorityCommand \u2014 pfcSession")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        throw CommandException.unsupported(
                "Session.UICreateMaxPriorityCommand", unsupportedReason());
    }
}
