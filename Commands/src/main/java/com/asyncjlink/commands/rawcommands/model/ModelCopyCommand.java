...
/**
 * Model.Copy &mdash; pfcModel.
 *
 * <pre>
 * void Copy(String, CopyInstructions) throws jxthrowable
 * </pre>
 */
public final class ModelCopyCommand implements Command {

    @Override public String name() { return "Model.Copy"; }
    @Override public String jlinkPackage() { return "pfcModel"; }
    @Override public String receiverType() { return "Model"; }
    @Override public String signature() { return "void Copy(String, CopyInstructions) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Model.Copy \u2014 pfcModel")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        target.Copy(value, copyInstructions);
        return Marshal.ok();
    }
}
