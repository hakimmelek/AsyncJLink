...
/**
 * Circle.GetRadius &mdash; pfcGeometry.
 *
 * <pre>
 * double GetRadius() throws jxthrowable
 * </pre>
 */
public final class CircleGetRadiusCommand implements Command {

    @Override public String name() { return "Circle.GetRadius"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Circle.GetRadius \u2014 pfcGeometry")
