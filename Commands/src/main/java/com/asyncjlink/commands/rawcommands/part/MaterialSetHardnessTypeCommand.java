...
/**
 * Material.SetHardnessType &mdash; pfcPart.
 *
 * <pre>
 * void SetHardnessType(String) throws jxthrowable
 * </pre>
 */
public final class MaterialSetHardnessTypeCommand implements Command {

    @Override public String name() { return "Material.SetHardnessType"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void SetHardnessType(String) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetHardnessType \u2014 pfcPart")
