...
/**
 * DetailSymbolGroup.Delete &mdash; pfcDetail.
 *
 * <pre>
 * void Delete() throws jxthrowable
 * </pre>
 */
public final class DetailSymbolGroupDeleteCommand implements Command {

    @Override public String name() { return "DetailSymbolGroup.Delete"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("DetailSymbolGroup.Delete \u2014 pfcDetail")
