...
/**
 * Dimension2D.GetView &mdash; pfcDimension2D.
 *
 * <pre>
 * View2D GetView() throws jxthrowable
 * </pre>
 */
public final class Dimension2DGetViewCommand implements Command {

    @Override public String name() { return "Dimension2D.GetView"; }
    @Override public String jlinkPackage() { return "pfcDimension2D"; }
    @Override public String receiverType() { return "Dimension2D"; }
    @Override public String signature() { return "View2D GetView() throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Dimension2D.GetView \u2014 pfcDimension2D")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.GetView(), "View2D");
    }
}
