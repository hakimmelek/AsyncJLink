...
/**
 * Material.GetId &mdash; pfcPart.
 *
 * <pre>
 * int GetId() throws jxthrowable
 * </pre>
 */
public final class MaterialGetIdCommand implements Command {

    @Override public String name() { return "Material.GetId"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.GetId \u2014 pfcPart")
