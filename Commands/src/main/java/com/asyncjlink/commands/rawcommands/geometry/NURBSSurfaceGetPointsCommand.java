...
/**
 * NURBSSurface.GetPoints &mdash; pfcGeometry.
 *
 * <pre>
 * BSplinePoints GetPoints() throws jxthrowable
 * </pre>
 */
public final class NURBSSurfaceGetPointsCommand implements Command {

    @Override public String name() { return "NURBSSurface.GetPoints"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("NURBSSurface.GetPoints \u2014 pfcGeometry")
