...
/**
 * Ellipse.GetEndAngle &mdash; pfcGeometry.
 *
 * <pre>
 * double GetEndAngle() throws jxthrowable
 * </pre>
 */
public final class EllipseGetEndAngleCommand implements Command {

    @Override public String name() { return "Ellipse.GetEndAngle"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Ellipse.GetEndAngle \u2014 pfcGeometry")
