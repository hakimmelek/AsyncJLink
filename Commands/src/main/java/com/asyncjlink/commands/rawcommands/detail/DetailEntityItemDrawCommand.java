...
/**
 * DetailEntityItem.Draw &mdash; pfcDetail.
 *
 * <pre>
 * void Draw() throws jxthrowable
 * </pre>
 */
public final class DetailEntityItemDrawCommand implements Command {

    @Override public String name() { return "DetailEntityItem.Draw"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("DetailEntityItem.Draw \u2014 pfcDetail")
