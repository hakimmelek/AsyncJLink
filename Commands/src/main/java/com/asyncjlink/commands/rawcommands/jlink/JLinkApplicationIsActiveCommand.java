...
/**
 * JLinkApplication.IsActive &mdash; pfcJLink.
 *
 * <pre>
 * boolean IsActive() throws jxthrowable
 * </pre>
 */
public final class JLinkApplicationIsActiveCommand implements Command {

    @Override public String name() { return "JLinkApplication.IsActive"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("JLinkApplication.IsActive \u2014 pfcJLink")
