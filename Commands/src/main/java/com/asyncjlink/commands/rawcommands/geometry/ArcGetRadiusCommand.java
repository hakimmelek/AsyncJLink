...
/**
 * Arc.GetRadius &mdash; pfcGeometry.
 *
 * <pre>
 * double GetRadius() throws jxthrowable
 * </pre>
 */
public final class ArcGetRadiusCommand implements Command {

    @Override public String name() { return "Arc.GetRadius"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Arc.GetRadius \u2014 pfcGeometry")
