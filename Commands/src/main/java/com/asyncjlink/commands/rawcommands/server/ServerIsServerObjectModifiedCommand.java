...
/**
 * Server.IsServerObjectModified &mdash; pfcServer.
 *
 * <pre>
 * ServerObjectStatus IsServerObjectModified(String, String) throws jxthrowable
 * </pre>
 */
public final class ServerIsServerObjectModifiedCommand implements Command {

    @Override public String name() { return "Server.IsServerObjectModified"; }
    @Override public String jlinkPackage() { return "pfcServer"; }
    @Override public String receiverType() { return "Server"; }
    @Override public String signature() { return "ServerObjectStatus IsServerObjectModified(String, String) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Server.IsServerObjectModified \u2014 pfcServer")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.IsServerObjectModified(value1, value2), "ServerObjectStatus");
    }
}
