...
/**
 * FamilyMember.CreateCompModelColumn &mdash; pfcFamily.
 *
 * <pre>
 * FamColCompModel CreateCompModelColumn(Feature) throws jxthrowable
 * </pre>
 */
public final class FamilyMemberCreateCompModelColumnCommand implements Command {

    @Override public String name() { return "FamilyMember.CreateCompModelColumn"; }
    @Override public String jlinkPackage() { return "pfcFamily"; }
    @Override public String receiverType() { return "FamilyMember"; }
    @Override public String signature() { return "FamColCompModel CreateCompModelColumn(Feature) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("FamilyMember.CreateCompModelColumn \u2014 pfcFamily")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.CreateCompModelColumn(feature), "FamColCompModel");
    }
}
