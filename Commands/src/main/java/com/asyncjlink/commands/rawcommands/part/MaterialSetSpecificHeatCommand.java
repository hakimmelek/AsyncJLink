...
/**
 * Material.SetSpecificHeat &mdash; pfcPart.
 *
 * <pre>
 * void SetSpecificHeat(double) throws jxthrowable
 * </pre>
 */
public final class MaterialSetSpecificHeatCommand implements Command {

    @Override public String name() { return "Material.SetSpecificHeat"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void SetSpecificHeat(double) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetSpecificHeat \u2014 pfcPart")
