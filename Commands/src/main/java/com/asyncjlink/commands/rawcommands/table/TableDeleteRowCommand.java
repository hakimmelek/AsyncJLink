...
/**
 * Table.DeleteRow &mdash; pfcTable.
 *
 * <pre>
 * void DeleteRow(int, Boolean) throws jxthrowable
 * </pre>
 */
public final class TableDeleteRowCommand implements Command {

    @Override public String name() { return "Table.DeleteRow"; }
    @Override public String jlinkPackage() { return "pfcTable"; }
    @Override public String receiverType() { return "Table"; }
    @Override public String signature() { return "void DeleteRow(int, Boolean) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Table.DeleteRow \u2014 pfcTable")
