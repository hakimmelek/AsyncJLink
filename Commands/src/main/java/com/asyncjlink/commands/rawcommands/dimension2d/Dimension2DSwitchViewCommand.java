...
/**
 * Dimension2D.SwitchView &mdash; pfcDimension2D.
 *
 * <pre>
 * void SwitchView(View2D) throws jxthrowable
 * </pre>
 */
public final class Dimension2DSwitchViewCommand implements Command {

    @Override public String name() { return "Dimension2D.SwitchView"; }
    @Override public String jlinkPackage() { return "pfcDimension2D"; }
    @Override public String receiverType() { return "Dimension2D"; }
    @Override public String signature() { return "void SwitchView(View2D) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Dimension2D.SwitchView \u2014 pfcDimension2D")
