...
/**
 * Model2D.SetCurrentSolid &mdash; pfcModel2D.
 *
 * <pre>
 * void SetCurrentSolid(Model) throws jxthrowable
 * </pre>
 */
public final class Model2DSetCurrentSolidCommand implements Command {

    @Override public String name() { return "Model2D.SetCurrentSolid"; }
    @Override public String jlinkPackage() { return "pfcModel2D"; }
    @Override public String receiverType() { return "Model2D"; }
    @Override public String signature() { return "void SetCurrentSolid(Model) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Model2D.SetCurrentSolid \u2014 pfcModel2D")
