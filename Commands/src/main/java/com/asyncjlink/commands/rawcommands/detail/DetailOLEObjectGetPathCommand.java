...
/**
 * DetailOLEObject.GetPath &mdash; pfcDetail.
 *
 * <pre>
 * String GetPath() throws jxthrowable
 * </pre>
 */
public final class DetailOLEObjectGetPathCommand implements Command {

    @Override public String name() { return "DetailOLEObject.GetPath"; }
    @Override public String jlinkPackage() { return "pfcDetail"; }
    @Override public String receiverType() { return "DetailOLEObject"; }
    @Override public String signature() { return "String GetPath() throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("DetailOLEObject.GetPath \u2014 pfcDetail")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.GetPath(), "String");
    }
}
