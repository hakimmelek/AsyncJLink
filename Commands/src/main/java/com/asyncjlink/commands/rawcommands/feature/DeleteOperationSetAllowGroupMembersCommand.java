...
/**
 * DeleteOperation.SetAllowGroupMembers &mdash; pfcFeature.
 *
 * <pre>
 * void SetAllowGroupMembers(boolean) throws jxthrowable
 * </pre>
 */
public final class DeleteOperationSetAllowGroupMembersCommand implements Command {

    @Override public String name() { return "DeleteOperation.SetAllowGroupMembers"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("DeleteOperation.SetAllowGroupMembers \u2014 pfcFeature")
