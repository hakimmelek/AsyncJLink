...
/**
 * ComponentPath.GetTransform &mdash; pfcAssembly.
 *
 * <pre>
 * Transform3D GetTransform(boolean) throws jxthrowable
 * </pre>
 */
public final class ComponentPathGetTransformCommand implements Command {

    @Override public String name() { return "ComponentPath.GetTransform"; }
    @Override public String jlinkPackage() { return "pfcAssembly"; }
    @Override public String receiverType() { return "ComponentPath"; }
    @Override public String signature() { return "Transform3D GetTransform(boolean) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("ComponentPath.GetTransform \u2014 pfcAssembly")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.GetTransform(flag), "Transform3D");
    }
}
