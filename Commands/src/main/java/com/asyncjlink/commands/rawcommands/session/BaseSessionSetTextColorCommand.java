...
/**
 * BaseSession.SetTextColor &mdash; pfcSession.
 *
 * <pre>
 * StdColor SetTextColor(StdColor) throws jxthrowable
 * </pre>
 */
public final class BaseSessionSetTextColorCommand implements Command {

    @Override public String name() { return "BaseSession.SetTextColor"; }
    @Override public String jlinkPackage() { return "pfcSession"; }
    @Override public String receiverType() { return "BaseSession"; }
    @Override public String signature() { return "StdColor SetTextColor(StdColor) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("BaseSession.SetTextColor \u2014 pfcSession")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.SetTextColor(stdColor), "StdColor");
    }
}
