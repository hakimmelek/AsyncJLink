...
/**
 * DetailSymbolInstItem.Erase &mdash; pfcDetail.
 *
 * <pre>
 * void Erase() throws jxthrowable
 * </pre>
 */
public final class DetailSymbolInstItemEraseCommand implements Command {

    @Override public String name() { return "DetailSymbolInstItem.Erase"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("DetailSymbolInstItem.Erase \u2014 pfcDetail")
