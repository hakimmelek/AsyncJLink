...
/**
 * Table.GetCellNote &mdash; pfcTable.
 *
 * <pre>
 * ModelItem GetCellNote(TableCell) throws jxthrowable
 * </pre>
 */
public final class TableGetCellNoteCommand implements Command {

    @Override public String name() { return "Table.GetCellNote"; }
    @Override public String jlinkPackage() { return "pfcTable"; }
    @Override public String receiverType() { return "Table"; }
    @Override public String signature() { return "ModelItem GetCellNote(TableCell) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Table.GetCellNote \u2014 pfcTable")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.GetCellNote(tableCell), "ModelItem");
    }
}
