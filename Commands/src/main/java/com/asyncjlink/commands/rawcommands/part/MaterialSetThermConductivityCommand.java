...
/**
 * Material.SetThermConductivity &mdash; pfcPart.
 *
 * <pre>
 * void SetThermConductivity(double) throws jxthrowable
 * </pre>
 */
public final class MaterialSetThermConductivityCommand implements Command {

    @Override public String name() { return "Material.SetThermConductivity"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void SetThermConductivity(double) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetThermConductivity \u2014 pfcPart")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        target.SetThermConductivity(value);
        return Marshal.ok();
    }
}
