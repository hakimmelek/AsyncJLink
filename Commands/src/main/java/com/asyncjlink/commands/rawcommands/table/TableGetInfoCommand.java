...
/**
 * Table.GetInfo &mdash; pfcTable.
 *
 * <pre>
 * TableInfo GetInfo(int) throws jxthrowable
 * </pre>
 */
public final class TableGetInfoCommand implements Command {

    @Override public String name() { return "Table.GetInfo"; }
    @Override public String jlinkPackage() { return "pfcTable"; }
    @Override public String receiverType() { return "Table"; }
    @Override public String signature() { return "TableInfo GetInfo(int) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Table.GetInfo \u2014 pfcTable")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        int value = Marshal.in(ctx, params.get("value"),
                "int", int.class, "value");
        return Marshal.result(ctx, target.GetInfo(value), "TableInfo");
    }
}
