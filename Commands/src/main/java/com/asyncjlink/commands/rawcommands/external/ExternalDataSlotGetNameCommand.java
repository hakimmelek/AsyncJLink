...
/**
 * ExternalDataSlot.GetName &mdash; pfcExternal.
 *
 * <pre>
 * String GetName() throws jxthrowable
 * </pre>
 */
public final class ExternalDataSlotGetNameCommand implements Command {

    @Override public String name() { return "ExternalDataSlot.GetName"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("ExternalDataSlot.GetName \u2014 pfcExternal")
