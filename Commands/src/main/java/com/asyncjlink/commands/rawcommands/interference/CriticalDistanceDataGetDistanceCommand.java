...
/**
 * CriticalDistanceData.GetDistance &mdash; pfcInterference.
 *
 * <pre>
 * double GetDistance() throws jxthrowable
 * </pre>
 */
public final class CriticalDistanceDataGetDistanceCommand implements Command {

    @Override public String name() { return "CriticalDistanceData.GetDistance"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("CriticalDistanceData.GetDistance \u2014 pfcInterference")
