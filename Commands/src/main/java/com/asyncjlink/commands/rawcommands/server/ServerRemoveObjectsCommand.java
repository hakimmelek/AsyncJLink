...
/**
 * Server.RemoveObjects &mdash; pfcServer.
 *
 * <pre>
 * void RemoveObjects(stringseq) throws jxthrowable
 * </pre>
 */
public final class ServerRemoveObjectsCommand implements Command {

    @Override public String name() { return "Server.RemoveObjects"; }
    @Override public String jlinkPackage() { return "pfcServer"; }
    @Override public String receiverType() { return "Server"; }
    @Override public String signature() { return "void RemoveObjects(stringseq) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Server.RemoveObjects \u2014 pfcServer")
