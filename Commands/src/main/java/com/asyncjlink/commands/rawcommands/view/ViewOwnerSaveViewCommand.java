...
/**
 * ViewOwner.SaveView &mdash; pfcView.
 *
 * <pre>
 * View SaveView(String) throws jxthrowable
 * </pre>
 */
public final class ViewOwnerSaveViewCommand implements Command {

    @Override public String name() { return "ViewOwner.SaveView"; }
    @Override public String jlinkPackage() { return "pfcView"; }
    @Override public String receiverType() { return "ViewOwner"; }
    @Override public String signature() { return "View SaveView(String) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("ViewOwner.SaveView \u2014 pfcView")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.SaveView(value), "View");
    }
}
