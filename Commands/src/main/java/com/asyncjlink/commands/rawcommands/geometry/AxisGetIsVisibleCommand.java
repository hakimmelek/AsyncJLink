...
/**
 * Axis.GetIsVisible &mdash; pfcGeometry.
 *
 * <pre>
 * boolean GetIsVisible() throws jxthrowable
 * </pre>
 */
public final class AxisGetIsVisibleCommand implements Command {

    @Override public String name() { return "Axis.GetIsVisible"; }
    ...
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Axis.GetIsVisible \u2014 pfcGeometry")
