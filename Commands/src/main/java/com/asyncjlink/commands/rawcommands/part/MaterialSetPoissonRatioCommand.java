...
/**
 * Material.SetPoissonRatio &mdash; pfcPart.
 *
 * <pre>
 * void SetPoissonRatio(double) throws jxthrowable
 * </pre>
 */
public final class MaterialSetPoissonRatioCommand implements Command {

    @Override public String name() { return "Material.SetPoissonRatio"; }
    @Override public String jlinkPackage() { return "pfcPart"; }
    @Override public String receiverType() { return "Material"; }
    @Override public String signature() { return "void SetPoissonRatio(double) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Material.SetPoissonRatio \u2014 pfcPart")
