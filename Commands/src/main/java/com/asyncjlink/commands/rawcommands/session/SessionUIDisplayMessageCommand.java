...
/**
 * Session.UIDisplayMessage &mdash; pfcSession.
 *
 * <pre>
 * void UIDisplayMessage(String, String, stringseq) throws jxthrowable
 * </pre>
 */
public final class SessionUIDisplayMessageCommand implements Command {

    @Override public String name() { return "Session.UIDisplayMessage"; }
    @Override public String jlinkPackage() { return "pfcSession"; }
    @Override public String receiverType() { return "Session"; }
    @Override public String signature() { return "void UIDisplayMessage(String, String, stringseq) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Session.UIDisplayMessage \u2014 pfcSession")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        target.UIDisplayMessage(value1, value2, values);
        return Marshal.ok();
    }
}
