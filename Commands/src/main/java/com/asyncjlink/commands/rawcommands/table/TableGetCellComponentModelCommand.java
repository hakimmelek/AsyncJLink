...
/**
 * Table.GetCellComponentModel &mdash; pfcTable.
 *
 * <pre>
 * ComponentPath GetCellComponentModel(TableCell) throws jxthrowable
 * </pre>
 */
public final class TableGetCellComponentModelCommand implements Command {

    @Override public String name() { return "Table.GetCellComponentModel"; }
    @Override public String jlinkPackage() { return "pfcTable"; }
    @Override public String receiverType() { return "Table"; }
    @Override public String signature() { return "ComponentPath GetCellComponentModel(TableCell) throws jxthrowable"; }

    @Override
    public JsonSchema paramSchema() {
        return JsonSchema.object()
                .describedAs("Table.GetCellComponentModel \u2014 pfcTable")
    ...
    public JsonObject execute(CreoContext ctx, JsonObject params) throws jxthrowable {
        ...
        return Marshal.result(ctx, target.GetCellComponentModel(tableCell), "ComponentPath");
    }
}
